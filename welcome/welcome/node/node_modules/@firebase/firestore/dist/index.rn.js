...
/** Returns the lowest value for the given value type (inclusive). */ function Xt(t, e) {
 ...
 */ class ne {
     ...
     */    static newInvalidDocument(t) {
        return new ne(t, 0 /* INVALID */ , ht.min(), ht.min(), te.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new ne(t, 1 /* FOUND_DOCUMENT */ , e, ht.min(), n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new ne(t, 2 /* NO_DOCUMENT */ , e, ht.min(), te.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new ne(t, 3 /* UNKNOWN_DOCUMENT */ , e, ht.min(), te.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
...
/** Returns a debug representation of the field index */ se.UNKNOWN_ID = -1;
 ...
 */ class he {
    ...
    /** Returns an offset that sorts before all regular offsets. */    static min() {
        return new he(ht.min(), kt.empty(), -1);
    }
    /** Returns an offset that sorts after all regular offsets. */    static max() {
        return new he(ht.max(), kt.empty(), -1);
    }
}
 ...
 */ class pe extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.V(t, e, n) : new Ie(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Re(t, n) : "in" /* IN */ === e ? new Pe(t, n) : "not-in" /* NOT_IN */ === e ? new be(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ve(t, n) : new pe(t, e, n);
    }
    static V(t, e, n) {
...
/** Filter that matches on key fields within an array. */ class Te extends pe {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class Ee extends pe {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class Re extends pe {
    constructor(t, e) {
...
/** A Filter that implements the IN operator. */ class Pe extends pe {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class be extends pe {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class Ve extends pe {
    constructor(t, e) {
...
/** Creates a new Query instance with the options provided. */ function ke(t, e, n, s, i, r, o, u) {
    return new Ne(t, e, n, s, i, r, o, u);
}
 ...
 */ function Ue(t) {
    ...
    if (null === e.D) {
        ...
        t.isKeyField() || e.D.push(new Se(t)), e.D.push(new Se(gt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function qe(t) {
    const e = G(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = de(e.path, e.collectionGroup, Ue(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new ve(e.endAt.position, !e.endAt.inclusive) : null, s = e.startAt ? new ve(e.startAt.position, !e.startAt.inclusive) : null;
...
function Ge(t, e) {
    return me(qe(t), qe(e)) && t.limitType === e.limitType;
}
...
function Qe(t) {
    return `${_e(qe(t))}|lt:${t.limitType}`;
}

function je(t) {
    return `Query(target=${we(qe(t))}; limitType=${t.limitType})`;
}
 ...
 */
        ...
        }(t.startAt, Ue(t), e)) return !1;
        if (t.endAt && !function(t, e, n) {
            const s = Ce(t, e, n);
            return t.inclusive ? s >= 0 : s > 0;
        }(t.endAt, Ue(t), e)) return !1;
        return !0;
    }
    /**
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ class tn {
    constructor() {
 ...
 */ function en(t, e, n) {
    ...
    }(n, e) : t instanceof on ? un(t, e) : t instanceof an ? cn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = sn(t, e), s = ln(n) + ln(t.k);
        return Qt(n) && Qt(t.k) ? Xe(s) : Ye(t.M, s);
    }(t, e);
}
 ...
 */ function nn(t, e, n) {
    ...
    // applications.
    return t instanceof on ? un(t, e) : t instanceof an ? cn(t, e) : n;
}
 ...
 */ function sn(t, e) {
    return t instanceof hn ? Qt(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class on extends tn {
    constructor(t) {
...
/** Transforms an array value via a remove operation. */ class an extends tn {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function _n(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof on && e instanceof on || t instanceof an && e instanceof an ? ut(t.elements, e.elements, $t) : t instanceof hn && e instanceof hn ? $t(t.k, e.k) : t instanceof rn && e instanceof rn;
 ...
 */ function pn(t, e, n) {
    t instanceof Rn ? function(t, e, n) {
        ...
        // must have held.
        const s = t.value.clone(), i = Vn(t.fieldTransforms, e, n.transformResults);
        ...
        const s = Vn(t.fieldTransforms, e, n.transformResults), i = e.data;
        i.setAll(bn(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function In(t, e, n) {
    t instanceof Rn ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = vn(t.fieldTransforms, n, e);
 ...
 *    ignored.
 */ (t, e, n) : t instanceof Pn ? function(t, e, n) {
        if (!gn(t.precondition, e)) return;
        const s = vn(t.fieldTransforms, n, e), i = e.data;
        i.setAll(bn(t)), i.setAll(s), e.convertToFoundDocument(An(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function Tn(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = sn(s.transform, t || null);
...
function En(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && ut(t, e, ((t, e) => _n(t, e)));
 ...
 */ function vn(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, en(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class Sn extends yn {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (Nn = xn || (xn = {}))[Nn.OK = 0] = "OK", Nn[Nn.CANCELLED = 1] = "CANCELLED", 
Nn[Nn.UNKNOWN = 2] = "UNKNOWN", Nn[Nn.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
Nn[Nn.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", Nn[Nn.NOT_FOUND = 5] = "NOT_FOUND", 
Nn[Nn.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", Nn[Nn.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
Nn[Nn.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", Nn[Nn.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
Nn[Nn.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", Nn[Nn.ABORTED = 10] = "ABORTED", 
Nn[Nn.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", Nn[Nn.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
Nn[Nn.INTERNAL = 13] = "INTERNAL", Nn[Nn.UNAVAILABLE = 14] = "UNAVAILABLE", Nn[Nn.DATA_LOSS = 15] = "DATA_LOSS";
...
class Fn {
    ...
    insert(t, e) {
        return new Fn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, Bn.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new Fn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, Bn.BLACK, null, null));
    }
    ...
    getIterator() {
        return new $n(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new $n(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new $n(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new $n(this.root, t, this.comparator, !0);
    }
}
...
class Bn {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : Bn.RED, this.left = null != s ? s : Bn.EMPTY, 
        this.right = null != i ? i : Bn.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new Bn(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return Bn.EMPTY;
...
class Ln {
    ...
    copy(t) {
        const e = new Ln(this.comparator);
        return e.data = t, e;
    }
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Kn = new Fn(kt.comparator);

function Gn() {
    return Kn;
}

const Qn = new Fn(kt.comparator);
...
function Wn() {
    return new On((t => t.toString()), ((t, e) => t.isEqual(e)));
}

const zn = new Fn(kt.comparator);

const Hn = new Ln(kt.comparator);
 ...
 */ class Zn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, ts.createSynthesizedTargetChangeForCurrentChange(t, e)), new Zn(ht.min(), n, Xn(), Gn(), Jn());
    }
}
 ...
 */ class ts {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new ts(Tt.EMPTY_BYTE_STRING, e, Jn(), Jn(), Jn());
    }
}
...
class rs {
     ...
     */    _t(t) {
        ...
        if (s) {
            ...
            if (ge(t)) if (0 === n) {
                ...
                this.ct(e, n, ne.newNoDocument(n, ht.min()));
            } else q(1 === n); else {
                this.gt(e) !== n && (
     ...
     */    yt(t) {
        ...
        const s = new Zn(t, e, this.ot, this.it, n);
        return this.it = Gn(), this.rt = os(), this.ot = new Ln(ot), s;
    }
    /**
    ...
    lt(t) {
        let e = this.st.get(t);
        return e || (e = new is, this.st.set(t, e)), e;
    }
    Tt(t) {
        let e = this.rt.get(t);
        return e || (e = new Ln(ot), this.rt = this.rt.insert(t, e)), e;
    }
    /**
...
function Is(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? wt.emptyPath() : Es(e);
}
...
/** Creates a Document proto from key and fields (but no create/update time) */ function As(t, e, n) {
    return {
        name: gs(t, e),
...
function Rs(t, e, n) {
    const s = ys(t, e.name), i = _s(e.updateTime), r = new te({
        mapValue: {
            fields: e.fields
        }
...
function Ps(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = ys(t, e.found.name), s = _s(e.found.updateTime), i = new te({
            mapValue: {
        ...
        const n = ys(t, e.missing), s = _s(e.readTime);
...
function bs(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? Q.UNKNOWN : Mn(t.code);
 ...
 */ (o);
        ...
        const i = ys(t, s.document.name), r = _s(s.document.updateTime), o = new te({
            mapValue: {
                fields: s.document.fields
            }
        }), u = ne.newFoundDocument(i, r, o), a = s.targetIds || [], c = s.removedTargetIds || [];
        n = new es(a, c, u.key, u);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = ys(t, s.document), r = s.readTime ? _s(s.readTime) : ht.min(), o = ne.newNoDocument(i, r), u = s.removedTargetIds || [];
        n = new es([], u, o.key, o);
    } else if ("documentRemove" in e) {
        e.documentRemove;
        const s = e.documentRemove;
        s.document;
        const i = ys(t, s.document), r = s.removedTargetIds || [];
        n = new es([], r, i, null);
    } else {
...
function Vs(t, e) {
    ...
    if (e instanceof Rn) n = {
        update: As(t, e.key, e.value)
    }; else if (e instanceof Sn) n = {
        delete: gs(t, e.key)
    }; else if (e instanceof Pn) n = {
        update: As(t, e.key, e.data),
        updateMask: Us(e.fieldMask)
    }; else {
        if (!(e instanceof Dn)) return U();
        n = {
            verify: gs(t, e.key)
        };
    }
...
function vs(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? mn.updateTime(_s(t.updateTime)) : void 0 !== t.exists ? mn.exists(t.exists) : mn.none();
    }(e.currentDocument) : mn.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) q("REQUEST_TIME" === e.setToServerValue), n = new rn; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new on(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new an(t);
        } else "increment" in e ? n = new hn(t, e.increment) : U();
        const s = gt.fromServerFormat(e.fieldPath);
        return new dn(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = ys(t, e.update.name), r = new te({
            mapValue: {
    ...
    if (e.delete) {
        const s = ys(t, e.delete);
        return new Sn(s, n);
    }
    if (e.verify) {
        const s = ys(t, e.verify);
        return new Dn(s, n);
    }
    return U();
}
...
function Ss(t, e) {
    return t && t.length > 0 ? (q(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? _s(t.updateTime) : _s(e);
        ...
        n = _s(e)), new wn(n, t.transformResults || []);
    }(t, e)))) : [];
}

function Ds(t, e) {
    return {
        documents: [ ps(t, e.path) ]
    };
}
...
function Cs(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = ps(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = ps(t, s.popLast()), n.structuredQuery.from = [ {
...
function xs(t) {
    ...
    let r = [];
    n.where && (r = ks(n.where));
    let o = [];
    n.orderBy && (o = n.orderBy.map((t => function(t) {
        return new Se($s(t.field), 
        // visible for testing
        function(t) {
            switch (t) {
              case "ASCENDING":
    ...
    // visible for testing
    (n.endAt)), ke(e, i, o, r, u, "F" /* First */ , a, c);
}
...
function ks(t) {
    return t ? void 0 !== t.unaryFilter ? [ Ls(t) ] : void 0 !== t.fieldFilter ? [ Bs(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => ks(t))).reduce(((t, e) => t.concat(e))) : U() : [];
}
...
function Bs(t) {
    return pe.create($s(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Ls(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        const e = $s(t.unaryFilter.field);
        return pe.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = $s(t.unaryFilter.field);
        return pe.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = $s(t.unaryFilter.field);
        return pe.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = $s(t.unaryFilter.field);
        return pe.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
...
function Ks(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = Qs(e)), e = Gs(t.get(n), e);
    return Qs(e);
}
...
/** Encodes a path separator into the given result */ function Qs(t) {
    return t + "";
}
 ...
 * information.
 */ const Js = {}, Ys = [ "prefixPath", "collectionGroup", "readTime", "documentId" ], Xs = [ "prefixPath", "collectionGroup", "documentId" ], Zs = [ "collectionGroup", "readTime", "prefixPath", "documentId" ], ti = [ "canonicalId", "targetId" ], ei = [ "targetId", "path" ], ni = [ "path", "targetId" ], si = [ "collectionId", "parent" ], ii = [ "indexId", "uid" ], ri = [ "uid", "sequenceNumber" ], oi = [ "indexId", "uid", "arrayValue", "directionalValue", "documentKey" ], ui = [ "indexId", "uid", "documentKey" ], ai = [ "userId", "collectionPath", "documentId" ], ci = [ "userId", "collectionPath", "largestBatchId" ], hi = [ "userId", "collectionGroup", "largestBatchId" ], li = [ ...[ ...[ ...[ ...[ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ], "clientMetadata" ], "remoteDocumentGlobal" ], "collectionParents" ], "bundles", "namedQueries" ], fi = [ ...li, "documentOverlays" ], di = [ "mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays" ], _i = [ ...di, "indexConfiguration", "indexState", "indexEntries" ];
 ...
 */ class gi {
    ...
    next(t, e) {
        return this.callbackAttached && U(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new gi(((n, s) => {
            this.nextCallback = e => {
    ...
    wrapUserFunction(t) {
        try {
            const e = t();
            return e instanceof gi ? e : gi.resolve(e);
        } catch (t) {
            return gi.reject(t);
        }
    }
    wrapSuccess(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : gi.resolve(e);
    }
    wrapFailure(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : gi.reject(e);
    }
    static resolve(t) {
        return new gi(((e, n) => {
            e(t);
     ...
     */    static or(t) {
        let e = gi.resolve(!1);
        for (const n of t) e = e.next((t => t ? gi.resolve(t) : n()));
        return e;
    }
    static forEach(t, e) {
        const n = [];
...
class yi {
    constructor(t, e) {
        ...
        this.At = new W, this.transaction.oncomplete = () => {
            ...
            e.error ? this.At.reject(new Ti(t, e.error)) : this.At.resolve();
        }, this.transaction.onerror = e => {
            const n = bi(e.target.error);
            this.At.reject(new Ti(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new yi(e, t.transaction(s, n));
        } catch (t) {
            throw new Ti(e, t);
        }
    }
 ...
 */ class pi {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === pi.Vt(h()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return F("SimpleDb", "Removing database:", t), Ri(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static vt() {
        ...
        // Check the UA string to find out the browser.
                const t = h(), e = pi.Vt(t), n = 0 < e && e < 10, s = pi.Dt(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async Nt(t) {
        return this.db || (F("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Ti(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = yi.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).next((t => (e.Pt(), 
                t))).catch((t => (
                // Abort the transaction if there was an error.
                e.abort(t), gi.reject(t)))).toPromise();
 ...
 */ class Ii {
     ...
     */    delete() {
        return Ri(this.Ft.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ti extends j {
    constructor(t, e) {
    ...
    Kt(t, e) {
        ...
        return new gi(((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new Ii(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof gi) {
                    const t = o.catch((t => (r.done(), gi.reject(t))));
                    n.push(t);
                }
 ...
 */ class Si {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && In(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && In(e, t, this.localWriteTime);
    }
    /**
    ...
    keys() {
        return this.mutations.reduce(((t, e) => t.add(e.key)), Jn());
    }
    isEqual(t) {
        return this.batchId === t.batchId && ut(this.mutations, t.mutations, ((t, e) => En(t, e))) && ut(this.baseMutations, t.baseMutations, ((t, e) => En(t, e)));
    }
}
 ...
 */ class xi {
    ...
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new xi(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new xi(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new xi(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function ki(t, e) {
    let n;
    if (e.document) n = Rs(t.Jt, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        const t = kt.fromSegments(e.noDocument.path), s = $i(e.noDocument.readTime);
        n = ne.newNoDocument(t, s), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return U();
        {
            const t = kt.fromSegments(e.unknownDocument.path), s = $i(e.unknownDocument.version);
...
/** Encodes a document for storage locally. */ function Mi(t, e) {
    ...
    if (e.isFoundDocument()) s.document = function(t, e) {
        ...
        path: n.path.toArray(),
        readTime: Fi(e.version)
    }; else {
        if (!e.isUnknownDocument()) return U();
        s.unknownDocument = {
            path: n.path.toArray(),
            version: Fi(e.version)
        };
    }
    return s;
}
...
function Bi(t, e) {
    const n = (e.baseMutations || []).map((e => vs(t.Jt, e)));
    ...
    const s = e.mutations.map((e => vs(t.Jt, e))), i = ct.fromMillis(e.localWriteTimeMs);
    return new Si(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Li(t) {
    const e = $i(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? $i(t.lastLimboFreeSnapshotVersion) : ht.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (q(1 === (i = t.query).documents.length), 
    s = qe(Me(Is(i.documents[0])))) : s = function(t) {
        return qe(xs(t));
    }(t.query), new xi(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Tt.fromBase64String(t.resumeToken));
}
...
/** Encodes TargetData into a DbTarget for storage locally. */ function Ui(t, e) {
    ...
    let i;
    i = ge(e.target) ? Ds(t.Jt, e.target) : Cs(t.Jt, e.target);
...
function qi(t) {
    ...
    return "LAST" === t.limitType ? Ke(e, e.limit, "L" /* Last */) : e;
}

/** Encodes a NamedQuery proto object to a NamedQuery model object. */
/** Encodes a DbDocumentOverlay object to an Overlay model object. */
function Ki(t, e) {
    return new Ci(e.largestBatchId, vs(t.Jt, e.overlayMutation));
}
 ...
 */ class zi {
    ...
    getOverlay(t, e) {
        return Hi(t).get(Gi(this.userId, e)).next((t => t ? Ki(this.M, t) : null));
    }
    saveOverlays(t, e, n) {
        const s = [];
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        // Get the set of unique collection paths.
                e.forEach((t => s.add(Ks(t.getCollectionPath()))));
        const i = [];
        return s.forEach((e => {
            const s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, n + 1 ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            i.push(Hi(t).Qt("collectionPathOverlayIndex", s));
        })), gi.waitFor(i);
    }
    getOverlaysForCollection(t, e, n) {
        const s = Wn(), i = Ks(e), r = IDBKeyRange.bound([ this.userId, i, n ], [ this.userId, i, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Hi(t).qt("collectionPathOverlayIndex", r).next((t => {
            for (const e of t) {
                const t = Ki(this.M, e);
                s.set(t.getKey(), t);
            }
    ...
    Xt(t, e) {
        return Hi(t).put(function(t, e, n) {
            const [s, i, r] = Gi(e, n.mutation.key);
            return {
                userId: e,
                collectionPath: i,
                documentId: r,
 ...
 */ class nr {
    constructor() {
        this.De = new Zi, this.Ce = new tr(this.De), this.xe = new er(this.De);
    }
    seed(t) {
        this.De.seed(t);
    }
 ...
 * limitations under the License.
 */
/** Represents an index entry saved by the SDK in persisted storage. */ class sr {
    constructor(t, e, n, s) {
     ...
     */    ke() {
        ...
        new sr(this.indexId, this.documentKey, this.arrayValue, n);
    }
}
 ...
 */ class ur {
    ...
    addToCollectionParentIndex(t, e) {
        return this.qe.add(e), gi.resolve();
    }
    getCollectionParents(t, e) {
        return gi.resolve(this.qe.getEntries(e));
    }
    addFieldIndex(t, e) {
 ...
 */ class ar {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Ln(wt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new Ln(wt.comparator)).toArray();
    }
}
...
class hr {
    constructor(t) {
         ...
         */
        this.Ge = new On((t => _e(t)), ((t, e) => me(t, e))), this.uid = t.uid || "";
    }
    /**
    ...
    getDocumentsMatchingTarget(t, e) {
        ...
        let s = !0;
        const i = new Map;
        return gi.forEach(this.Qe(e), (e => this.getFieldIndex(t, e).next((t => {
            s && (s = !!t), i.set(e, t);
        })))).next((() => {
            if (s) {
                let t = Jn();
                return gi.forEach(i, ((s, i) => {
                    var r;
                    F("IndexedDbIndexManager", `Using index ${r = s, `id=${r.indexId}|cg=${r.collectionGroup}|f=${r.fields.map((t => `${t.fieldPath}:${t.kind}`)).join(",")}`} to execute ${_e(e)}`);
                    const o = function(t, e) {
                        const n = ie(e);
 ...
 */ (i, s), a = function(t, e) {
                        ...
                        // startAt.
                            ...
                            for (const n of ye(t, r.fieldPath)) {
                                let t, s = !0;
                                switch (n.op) {
                                  case "<" /* LESS_THAN */ :
                                  case "<=" /* LESS_THAN_OR_EQUAL */ :
                                    t = "nullValue" in (i = n.value) ? Ot : "booleanValue" in i ? {
                                        booleanValue: !1
                                        ...
                                        bytesValue: ""
                                    } : "referenceValue" in i ? Gt(Dt.empty(), kt.empty()) : "geoPointValue" in i ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
 ...
 // Remaining filters cannot be used as lower bounds.
                            ...
                            // boundary to see if we can narrow the scope.
                                ...
                                Xt(e, s) === s && (e = s, o = t.startAt.inclusive);
                                break;
                            }
                            if (void 0 === e) 
                        ...
                        var i;
                        /** Returns the largest value for the given value type (exclusive). */                        return new ve(n, s);
                    }
                    /**
 ...
 */ (i, s), c = function(t, e) {
                                ...
                                switch (n.op) {
                                  ...
                                  case ">" /* GREATER_THAN */ :
                                    t = "nullValue" in (i = n.value) ? {
                                        ...
                                        bytesValue: ""
                                    } : "bytesValue" in i ? Gt(Dt.empty(), kt.empty()) : "referenceValue" in i ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
 ...
 // Remaining filters cannot be used as upper bounds.
                            ...
                            // boundary to see if we can narrow the scope.
                                ...
                                Zt(e, s) === s && (e = s, o = t.endAt.inclusive);
                                break;
                            }
                            if (void 0 === e) 
                    ...
                    return gi.forEach(d, (s => n.Gt(s, e.limit).next((e => {
                        e.forEach((e => {
                            t = t.add(new kt(js(e.documentKey)));
                        }));
                    }))));
                })).next((() => t));
            }
     ...
     */    ze(t, e, n, s, i, r, o) {
        ...
        for (let h = 0; h < u; ++h) {
            const u = e ? this.He(e[h / a]) : cr, l = n ? this.Je(t, u, n[h % a], s) : this.Ye(t), f = i ? this.Xe(t, u, i[h % a], r) : this.Ye(t + 1);
     ...
     * and user.
     */    Ye(t) {
        return new sr(t, kt.empty(), cr, cr);
    }
    getFieldIndex(t, e) {
    ...
    /** Encodes a single value to the ascending index format. */    He(t) {
        const e = new nr;
        return Ji.fe.Zt(t, e.Ne(0 /* ASCENDING */)), e.Se();
    }
    /**
     ...
     */    We(t, e, n) {
        ...
        for (const r of re(t)) {
            const t = n[i++];
            for (const n of s) if (this.tn(e, r.fieldPath) && jt(t)) s = this.en(s, r, t); else {
                const e = n.Ne(r.kind);
                Ji.fe.Zt(t, e);
            }
        }
     ...
     */    en(t, e, n) {
        ...
        for (const t of n.arrayValue.values || []) for (const n of s) {
            const s = new nr;
            s.seed(n.Se()), Ji.fe.Zt(t, s.Ne(e.kind)), i.push(s);
        }
        return i;
    }
    tn(t, e) {
        return !!t.filters.find((t => t instanceof pe && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op)));
    }
    getFieldIndexes(t, e) {
        const n = dr(t), s = _r(t);
        return (e ? n.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.qt()).next((t => {
            const e = [];
            return gi.forEach(t, (t => s.get([ t.indexId, this.uid ]).next((n => {
                e.push(function(t, e) {
                    const n = e ? new ue(e.sequenceNumber, new he($i(e.readTime), new kt(js(e.documentKey)), e.largestBatchId)) : ue.empty(), s = t.fields.map((([t, e]) => new oe(gt.fromServerFormat(t), e)));
    ...
    updateCollectionGroup(t, e, n) {
        const s = dr(t), i = _r(t);
        return this.sn(t).next((t => s.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e => gi.forEach(e, (e => i.put(function(t, e, n, s) {
            return {
                indexId: t,
                uid: e.uid || "",
                sequenceNumber: n,
                readTime: Fi(s.readTime),
                documentKey: Ks(s.documentKey.path),
    ...
    updateIndexEntries(t, e) {
        ...
        // here.
        const n = new Map;
        return gi.forEach(e, ((e, s) => {
            const i = n.get(e.collectionGroup);
            return (i ? gi.resolve(i) : this.getFieldIndexes(t, e.collectionGroup)).next((i => (n.set(e.collectionGroup, i), 
            gi.forEach(i, (n => this.rn(t, e, n).next((e => {
                const i = this.on(s, n);
                return e.isEqual(i) ? gi.resolve() : this.un(t, s, e, i);
            })))))));
        }));
    }
    an(t, e, n) {
        return fr(t).put({
            ...
            documentKey: Ks(e.key.path)
        });
    }
    cn(t, e, n) {
        return fr(t).delete([ n.indexId, this.uid, n.arrayValue, n.directionalValue, Ks(e.key.path) ]);
    }
    rn(t, e, n) {
        const s = fr(t);
        let i = new Ln(ir);
        return s.Wt({
            ...
            range: IDBKeyRange.only([ n.indexId, this.uid, Ks(e.path) ])
        }, ((t, s) => {
            i = i.add(new sr(n.indexId, e, s.arrayValue, s.directionalValue));
        })).next((() => i));
    }
    /** Creates the index entries for the given document. */    on(t, e) {
        ...
        if (null != i) {
            ...
            if (jt(r)) for (const i of r.arrayValue.values || []) n = n.add(new sr(e.indexId, t.key, this.He(i), s));
        } else n = n.add(new sr(e.indexId, t.key, cr, s));
        return n;
    }
    /**
     ...
     */    un(t, e, n, s) {
        ...
        return function(t, e, n, s, i) {
            ...
            for (;u || a; ) {
                ...
                t ? (s(a), a = qn(o)) : e ? (i(u), u = qn(r)) : (u = qn(r), a = qn(o));
            }
        }(n, s, ir, (
        /* onAdd= */ n => {
     ...
     */    createRange(t, e, n) {
        ...
        n = n.sort(((t, e) => ir(t, e))).filter(((t, e, n) => !e || 0 !== ir(t, n[e - 1])));
        const s = [];
        s.push(t);
        for (const i of n) {
            const n = ir(i, t), r = ir(i, e);
            if (0 === n) 
 ...
 * document store.
 */ function lr(t) {
    return vi(t, "collectionParents");
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function fr(t) {
    return vi(t, "indexEntries");
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function dr(t) {
    return vi(t, "indexConfiguration");
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function _r(t) {
    return vi(t, "indexState");
}
...
class mr {
    ...
    static withCacheSize(t) {
        return new mr(t, mr.DEFAULT_COLLECTION_PERCENTILE, mr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
...
function gr(t, e, n) {
    ...
    for (const t of n.mutations) {
        const s = Hs(e, t.key.path, n.batchId);
        r.push(i.delete(s)), c.push(t.key);
    }
    return gi.waitFor(r).next((() => c));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ mr.DEFAULT_COLLECTION_PERCENTILE = 10, 
mr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, mr.DEFAULT = new mr(41943040, mr.DEFAULT_COLLECTION_PERCENTILE, mr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
mr.DISABLED = new mr(-1, 0, 0);
...
class pr {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            q("number" == typeof o);
            const u = new Si(o, e, n, s), a = function(t, e, n) {
            ...
            let h = new Ln(((t, e) => ot(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = Hs(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), c.push(r.put(a)), c.push(i.put(e, Js));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return Tr(t).get(e).next((t => t ? (q(t.userId === this.userId), Bi(this.M, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    ln(t, e) {
        return this.hn[e] ? gi.resolve(this.hn[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Tr(t).Wt({
            ...
            e.userId === this.userId && (q(e.batchId >= n), i = Bi(this.M, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Tr(t).qt("userMutationsIndex", e).next((t => t.map((t => Bi(this.M, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = zs(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Er(t).Wt({
            range: s
        }, ((n, s, r) => {
            ...
            return Tr(t).get(a).next((t => {
                if (!t) throw U();
                q(t.userId === this.userId), i.push(Bi(this.M, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = zs(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Er(t).Wt({
                range: r
            }, ((t, s, i) => {
            ...
            s.push(o);
        })), gi.waitFor(s).next((() => this.fn(t, n)));
    }
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = zs(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    fn(t, e) {
        ...
        return e.forEach((e => {
            s.push(Tr(t).get(e).next((t => {
                if (null === t) throw U();
                q(t.userId === this.userId), n.push(Bi(this.M, t));
            })));
        })), gi.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return gr(t.Ht, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.dn(e.batchId);
        })), gi.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
    }
    /**
    ...
    _n(t) {
        return Ar(t).get(this.userId).next((t => t || {
            userId: this.userId,
 ...
 */ function Ir(t, e, n) {
    const s = zs(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Er(t).Wt({
        range: r,
        jt: !0
 ...
 */
function Tr(t) {
    return vi(t, "mutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Er(t) {
    return vi(t, "documentMutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ar(t) {
    return vi(t, "mutationQueues");
}
 ...
 */ class Pr {
    ...
    allocateTargetId(t) {
        return this.yn(t).next((e => {
            const n = new Rr(e.highestTargetId);
            return e.highestTargetId = n.next(), this.pn(t, e).next((() => e.highestTargetId));
        }));
    }
    getLastRemoteSnapshotVersion(t) {
        return this.yn(t).next((t => ht.fromTimestamp(new ct(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => br(t).delete(e.targetId))).next((() => this.yn(t))).next((e => (q(e.targetCount > 0), 
    ...
    yn(t) {
        return Vr(t).get("targetGlobalKey").next((t => (q(null !== t), t)));
    }
    pn(t, e) {
        return Vr(t).put("targetGlobalKey", e);
    }
    In(t, e) {
        return br(t).put(Ui(this.M, e));
    }
    /**
    ...
    removeMatchingKeys(t, e, n) {
        ...
        // IndexedDb.
        const s = vr(t);
        return gi.forEach(e, (e => {
            const i = Ks(e.path);
            return gi.waitFor([ s.delete([ n, i ]), this.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }
    removeMatchingKeysForTargetId(t, e) {
        const n = vr(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    ...
    containsKey(t, e) {
        const n = Ks(e.path), s = IDBKeyRange.bound([ n ], [ at(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return vr(t).Wt({
    ...
    // PORTING NOTE: Multi-tab only.
    Et(t, e) {
        return br(t).get(e).next((t => t ? Li(t) : null));
    }
}
 ...
 */ function Vr(t) {
    return vi(t, "targetGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function vr(t) {
    return vi(t, "targetDocuments");
}
 ...
 */ async function Sr(t) {
    if (t.code !== Q.FAILED_PRECONDITION || t.message !== wi) throw t;
 ...
 */ class Cr {
    constructor(t) {
        this.En = t, this.buffer = new Ln(Dr), this.An = 0;
    }
    Rn() {
        return ++this.An;
    }
    Pn(t) {
        ...
        if (this.buffer.size < this.En) this.buffer = this.buffer.add(e); else {
            ...
            Dr(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
 ...
 */ class xr {
    constructor(t, e) {
        this.garbageCollector = t, this.asyncQueue = e, this.bn = !1, this.Vn = null;
    }
    start(t) {
    ...
    vn(t) {
        ...
        F("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Vn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this.Vn = null, this.bn = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                Ei(t) ? F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Sr(t);
            }
            await this.vn(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Nr {
    constructor(t, e) {
    ...
    nthSequenceNumber(t, e) {
        if (0 === e) return gi.resolve(st.A);
        const n = new Cr(e);
        return this.Sn.forEachTarget(t, (t => n.Pn(t.sequenceNumber))).next((() => this.Sn.Cn(t, (t => n.Pn(t))))).next((() => n.maxValue));
    }
    removeTargets(t, e, n) {
    ...
    collect(t, e) {
        ...
        gi.resolve(wr)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        wr) : this.xn(t, e)));
    }
    getCacheSize(t) {
...
class kr {
     ...
     */    Mn(t, e) {
        return function(t, e) {
            let n = !1;
            return Ar(t).zt((s => Ir(t, s, e).next((t => (t && (n = !0), gi.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.kn(t, ((r, o) => {
            if (o <= e) {
                const e = this.Mn(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r, ht.min()), vr(t).delete([ 0, Ks(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => gi.waitFor(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
 ...
 */ class Or {
    constructor() {
        ...
        this.changes = new On((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
    }
    /**
     ...
     */    getEntry(t, e) {
        ...
        return void 0 !== n ? gi.resolve(n) : this.getFromCache(t, e);
    }
    /**
 ...
 */
        function(t, e) {
            ...
            /* collection id */ n[n.length - 2], Oi(e), 
 ...
 */ (e, n));
     ...
     */    Ln(t, e) {
        let n = Gn(), s = new Fn(kt.comparator);
        return this.Bn(t, e, ((t, e) => {
            const i = this.Fn(t, e);
    ...
    Bn(t, e, n) {
        if (e.isEmpty()) return gi.resolve();
        let s = new Ln(Kr);
        e.forEach((t => s = s.add(t)));
        const i = IDBKeyRange.bound(Ur(s.first()), Ur(s.last())), r = s.getIterator();
        let o = r.getNext();
        return Lr(t).Wt({
            index: "documentKeyIndex",
            range: i
            ...
            // Go through keys not found in cache.
                        for (;o && Kr(o, i) < 0; ) n(o, null), o = r.getNext();
            o && o.isEqual(i) && (
            // Key found in cache.
    ...
    getAllFromCollection(t, e, n) {
        const s = [ e.popLast().toArray(), e.lastSegment(), Oi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], i = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Lr(t).qt(IDBKeyRange.bound(s, i, !0)).next((t => {
            let e = Gn();
            for (const n of t) {
                const t = this.Fn(kt.fromSegments(n.prefixPath.concat(n.collectionGroup, n.documentId)), n);
                e = e.insert(t.key, t);
            }
            return e;
        }));
    ...
    getAllFromCollectionGroup(t, e, n, s) {
        let i = Gn();
        const r = qr(e, n), o = qr(e, he.max());
        return Lr(t).Wt({
            index: "collectionGroupIndex",
            range: IDBKeyRange.bound(r, o, !0)
        }, ((t, e, n) => {
            const r = this.Fn(kt.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
            i = i.insert(r.key, r), i.size === s && n.done();
        })).next((() => i));
    }
    newChangeBuffer(t) {
        return new $r(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return Br(t).get("remoteDocumentGlobalKey").next((t => (q(!!t), t)));
    }
    On(t, e) {
        return Br(t).put("remoteDocumentGlobalKey", e);
    }
    /**
...
class $r extends Or {
    ...
    constructor(t, e) {
        ...
        // this buffer.
        this.Kn = new On((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new Ln(((t, e) => ot(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Kn.get(i);
            if (e.push(this.qn.removeEntry(t, i, o.readTime)), r.isValidDocument()) {
                const u = Mi(this.qn.M, r);
                ...
                const n = Mi(this.qn.M, r.convertToNoDocument(ht.min()));
                e.push(this.qn.addEntry(t, i, n));
            }
        })), s.forEach((n => {
            e.push(this.qn.indexManager.addToCollectionParentIndex(t, n));
        })), e.push(this.qn.updateMetadata(t, n)), gi.waitFor(e);
    }
    getFromCache(t, e) {
        // Record the size of everything we load from the cache so we can compute a delta later.
        return this.qn.$n(t, e).next((t => (this.Kn.set(e, {
            size: t.size,
...
function Br(t) {
    return vi(t, "remoteDocumentGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Lr(t) {
    return vi(t, "remoteDocumentsV14");
}
...
class Gr {
     ...
     */    kt(t, e, n, s) {
        const i = new yi("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
            ...
            t.createObjectStore("mutations", {
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", Ws, {
                unique: !0
 ...
 */
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", ci, {
                    unique: !1
                }), e.createIndex("collectionGroupOverlayIndex", hi, {
                    unique: !1
                });
            }(t);
            ...
            e.createIndex("documentKeyIndex", Xs), e.createIndex("collectionGroupIndex", Zs);
        ...
        n < 14 && s >= 14 && (r = r.next((() => {
            !function(t) {
                ...
                t.createObjectStore("indexEntries", {
                    keyPath: oi
                }).createIndex("documentKeyIndex", ui, {
                    unique: !1
                });
            }(t);
        }))), r;
    ...
    Gn(t) {
        ...
        return e.qt().next((e => gi.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.qt("userMutationsIndex", s).next((n => gi.forEach(n, (n => {
                q(n.userId === e.userId);
                const s = Bi(this.M, n);
     ...
     */    jn(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((t => {
            ...
            return n.Wt(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? gi.resolve() : (n => e.put({
                    targetId: 0,
                    path: Ks(n),
    ...
    Wn(t, e) {
        ...
        const n = e.store("collectionParents"), s = new ar, i = t => {
            if (s.add(t)) {
...
class Wr {
    ...
    c, h = 13) {
        ...
        this.us = t => Promise.resolve(), !Wr.vt()) throw new j(Q.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new kr(this, s), this.cs = e + "main", this.M = new Ni(u), 
        this.hs = new pi(this.cs, this.Zn, new Gr(this.M)), this.ls = new Pr(this.referenceDelegate, this.M), 
        this.fs = function(t) {
            return new Fr(t);
        }(this.M), this.ds = new Qi, this.window && this.window.localStorage ? this._s = this.window.localStorage : (this._s = null, 
     ...
     * primary lease.
     */    ws() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Hr(t).put({
    ...
    Ts(t) {
        return zr(t).get("owner").next((t => gi.resolve(this.Ps(t))));
    }
    bs(t) {
        return Hr(t).delete(this.clientId);
    }
    /**
     ...
     */    async Vs() {
        if (this.isPrimary && !this.vs(this.os, 18e5)) {
            ...
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t => {
                const e = vi(t, "clientMetadata");
                return e.qt().next((t => {
                    const n = this.Ss(t, 18e5), s = t.filter((t => -1 === n.indexOf(t)));
                    // Delete metadata for clients that are no longer considered active.
                    return gi.forEach(s, (t => e.delete(t.clientId))).next((() => s));
                }));
            })).catch((() => []));
     ...
     */    Es(t) {
        if (this.Xn) return gi.resolve(!0);
        return zr(t).get("owner").next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Hr(t).qt().next((t => void 0 === this.Ss(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        await this.hs.runTransaction("shutdown", "readwrite", [ "owner", "clientMetadata" ], (t => {
            const e = new Vi(t, st.A);
            return this.As(e).next((() => this.bs(e)));
        })), this.hs.close(), 
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Os() {
        return this.runTransaction("getActiveClients", "readonly", (t => Hr(t).qt().next((t => this.Ss(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.es;
    }
    getMutationQueue(t, e) {
        return pr.Yt(t, this.M, e, this.referenceDelegate);
    }
    getTargetCache() {
        return this.ls;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = "readonly" === e ? "readonly" : "readwrite", i = 14 === (r = this.Zn) ? _i : 13 === r ? di : 12 === r ? fi : 11 === r ? li : void U();
        /** Returns the object stores for the provided schema. */
        var r;
        let o;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.hs.runTransaction(t, s, i, (s => (o = new Vi(s, this.ts ? this.ts.next() : st.A), 
        "readwrite-primary" === e ? this.Ts(o).next((t => !!t || this.Es(o))).next((e => {
            ...
            this.Jn.enqueueRetryable((() => this.us(!1))), new j(Q.FAILED_PRECONDITION, wi);
            return n(o);
    ...
    // be turned off.
    Fs(t) {
        return zr(t).get("owner").next((t => {
            if (null !== t && this.vs(t.leaseTimestampMs, 5e3) && !this.Cs(t.ownerId) && !this.Ps(t) && !(this.Xn || this.allowTabSynchronization && t.allowTabSynchronization)) throw new j(Q.FAILED_PRECONDITION, jr);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    As(t) {
        const e = zr(t);
        return e.get("owner").next((t => this.Ps(t) ? (F("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete("owner")) : gi.resolve()));
    }
     ...
     */    ys() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ns = () => {
            ...
            this.xs(), f() && navigator.appVersion.match(/Version\/1[45]/) && 
...
class Yr {
     ...
     */    qs(t, e) {
        return this.fs.getEntries(t, e).next((e => this.Ks(t, e).next((() => e))));
    }
    /**
 ...
 */
        return function(t) {
            return kt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Qs(t, e.path) : Le(e) ? this.js(t, e, n) : this.Ws(t, e, n);
    }
    Qs(t, e) {
        // Just do a simple document lookup.
        return this.Bs(t, new kt(e)).next((t => {
            let e = jn();
    ...
    js(t, e, n) {
        ...
        let i = jn();
        return this.indexManager.getCollectionParents(t, s).next((r => gi.forEach(r, (r => {
            const o = function(t, e) {
                return new Ne(e, 
    ...
    Ws(t, e, n) {
        ...
        return this.fs.getAllFromCollection(t, e.path, n).next((n => (s = n, this.$s.getAllMutationBatchesAffectingQuery(t, e)))).next((t => {
            for (const e of t) for (const t of e.mutations) {
                ...
                i = ne.newInvalidDocument(n), s = s.insert(n, i)), In(t, i, e.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        })).next((() => (
 ...
 */ class Xr {
 ...
 // do nothing
        ...
        return new Xr(t, e.fromCache, n, s);
    }
}
 ...
 */ class Zr {
    ...
    /** Returns all local documents matching the specified query. */    Gs(t, e, n, s) {
        ...
        }(e) || n.isEqual(ht.min()) ? this.Zs(t, e) : this.Xs.qs(t, s).next((i => {
            const r = this.ti(e, i);
            return (Oe(e) || Fe(e)) && this.ei(e.limitType, r, s, n) ? this.Zs(t, e) : (M() <= u.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), je(e)), 
            this.Xs.Gs(t, e, ae(n, -1)).next((t => (
...
class to {
    ...
    ui(t) {
        ...
        this.ai = new Yr(this.oi, this.$s, this.indexManager), this.oi.setIndexManager(this.indexManager), 
        this.ni.Ys(this.ai);
    }
    collectGarbage(t) {
...
function ao(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, gi.resolve(s)) : n.ls.allocateTargetId(t).next((i => (s = new xi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function ho(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        ...
        return void 0 !== i ? gi.resolve(s.si.get(i)) : s.ls.getTargetData(e, n);
    }(s, t, qe(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.ls.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.ni.Gs(t, e, n ? i : ht.min(), n ? r : Jn()))).next((t => (_o(s, ze(e), t), 
    {
        documents: t,
        hi: r
    })))));
...
// PORTING NOTE: Multi-Tab only.
function fo(t, e) {
    const n = G(t), s = n.ri.get(e) || ht.min();
    // Get the current maximum read time for the collection. This should always
    // exist, but to reduce the chance for regressions we default to
    // SnapshotVersion.Min()
    // TODO(indexing): Consider removing the default value.
        return n.persistence.runTransaction("Get new document changes", "readonly", (t => n.oi.getAllFromCollectionGroup(t, e, ae(s, -1), 
    /* limit= */ Number.MAX_SAFE_INTEGER))).then((t => (_o(n, e, t), t)));
}
...
async function wo(t, e, n, s) {
    ...
    const u = i.oi.newChangeBuffer({
        trackRemovals: !0
    }), a = await ao(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return qe(Me(wt.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => oo(t, u, o).next((e => (u.apply(t), 
    e))).next((e => i.ls.removeMatchingKeysForTargetId(t, a.targetId).next((() => i.ls.addMatchingKeys(t, r, a.targetId))).next((() => i.ai.Ks(t, e))).next((() => e))))));
}
 ...
 */
async function mo(t, e, n = Jn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await ao(t, qe(qi(e.bundledQuery))), i = G(t);
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        const r = _s(e.readTime);
 ...
 */ class go {
    ...
    getBundleMetadata(t, e) {
        return gi.resolve(this._i.get(e));
    }
    saveBundleMetadata(t, e) {
        ...
        return this._i.set(e.id, {
            id: (n = e).id,
            version: n.version,
            createTime: _s(n.createTime)
        }), gi.resolve();
    }
    getNamedQuery(t, e) {
        return gi.resolve(this.wi.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class yo {
    constructor() {
        ...
        this.overlays = new Fn(kt.comparator), this.mi = new Map;
    }
    getOverlay(t, e) {
        return gi.resolve(this.overlays.get(e));
    }
    saveOverlays(t, e, n) {
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        this.mi.delete(n)), gi.resolve();
    }
    getOverlaysForCollection(t, e, n) {
        const s = Wn(), i = e.length + 1, r = new kt(e.child("")), o = this.overlays.getIteratorFrom(r);
        for (;o.hasNext(); ) {
    ...
    getOverlaysForCollectionGroup(t, e, n, s) {
        let i = new Fn(((t, e) => t - e));
        const r = this.overlays.getIterator();
        for (;r.hasNext(); ) {
            const t = r.getNext().value;
            if (t.getKey().getCollectionGroup() === e && t.largestBatchId > n) {
                let e = i.get(t.largestBatchId);
                null === e && (e = Wn(), i = i.insert(t.largestBatchId, e)), e.set(t.getKey(), t);
            }
        }
        const o = Wn(), u = i.getIterator();
        for (;u.hasNext(); ) {
    ...
    Xt(t, e, n) {
        ...
        let i = this.mi.get(e);
        void 0 === i && (i = Jn(), this.mi.set(e, i)), this.mi.set(e, i.add(n.key));
    }
}
 ...
 */ class po {
    constructor() {
        ...
        this.gi = new Ln(Io.yi), 
        // A set of outstanding references to a document sorted by target id.
        this.pi = new Ln(Io.Ii);
    }
     ...
     * removed.
     */    Ri(t) {
        const e = new kt(new wt([])), n = new Io(e, t), s = new Io(e, t + 1), i = [];
    ...
    bi(t) {
        const e = new kt(new wt([])), n = new Io(e, t), s = new Io(e, t + 1);
        let i = Jn();
        return this.pi.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new Io(t, 0), n = this.gi.firstAfterOrEqual(e);
 ...
 */ class To {
    constructor(t, e) {
        ...
        this.Si = new Ln(Io.yi);
    }
    checkEmpty(t) {
        return gi.resolve(0 === this.$s.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.vi;
        ...
        for (const e of s) this.Si = this.Si.add(new Io(e.key, i)), this.indexManager.addToCollectionParentIndex(t, e.key.path.popLast());
        return gi.resolve(r);
    }
    lookupMutationBatch(t, e) {
        return gi.resolve(this.Di(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.Ci(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return gi.resolve(this.$s.length > i ? this.$s[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return gi.resolve(0 === this.$s.length ? -1 : this.vi - 1);
    }
    getAllMutationBatches(t) {
        return gi.resolve(this.$s.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    removeMutationBatch(t, e) {
        q(0 === this.Ni(e.batchId, "removed")), this.$s.shift();
        let n = this.Si;
        return gi.forEach(e.mutations, (s => {
    ...
    containsKey(t, e) {
        const n = new Io(e, 0), s = this.Si.firstAfterOrEqual(n);
        return gi.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this.$s.length, gi.resolve();
    }
    /**
...
class Eo {
    ...
    constructor(t) {
        ...
        this.docs = new Fn(kt.comparator), 
    ...
    getEntry(t, e) {
        ...
        return gi.resolve(n ? n.document.mutableCopy() : ne.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = Gn();
        return e.forEach((t => {
    ...
    Mi(t, e) {
        return gi.forEach(this.docs, (t => e(t)));
    }
    newChangeBuffer(t) {
 ...
 */ class Ro {
    constructor(t) {
         ...
         * IDs.
         */
        this.$i = new po, this.targetCount = 0, this.Bi = Rr.mn();
    }
    forEachTarget(t, e) {
        return this.Oi.forEach(((t, n) => e(n))), gi.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return gi.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return gi.resolve(this.Fi);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.Bi.next(), gi.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    In(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Bi = new Rr(e), this.highestTargetId = e), t.sequenceNumber > this.Fi && (this.Fi = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.In(e), this.targetCount += 1, gi.resolve();
    }
    updateTargetData(t, e) {
        return this.In(e), gi.resolve();
    }
    removeTargetData(t, e) {
    ...
    getTargetCount(t) {
        return gi.resolve(this.targetCount);
    }
    getTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this.$i.Ti(e, n), gi.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.$i.Ai(e, n);
    ...
    containsKey(t, e) {
        return gi.resolve(this.$i.containsKey(e));
    }
}
...
class Po {
    ...
    constructor(t, e) {
        ...
        this.referenceDelegate = t(this), this.ls = new Ro(this);
        this.indexManager = new ur, this.fs = function(t) {
            return new Eo(t);
        }((t => this.referenceDelegate.Ui(t))), this.M = new Ni(e), this.ds = new go(this.M);
    }
    start() {
    ...
    getDocumentOverlayCache(t) {
        ...
        return e || (e = new yo, this.overlays[t.toKey()] = e), e;
    }
    getMutationQueue(t, e) {
        let n = this.Li[t.toKey()];
        return n || (n = new To(e, this.referenceDelegate), this.Li[t.toKey()] = n), n;
    }
    getTargetCache() {
        return this.ls;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new bo(this.ts.next());
        return this.referenceDelegate.qi(), n(s).next((t => this.referenceDelegate.Ki(s).next((() => t)))).toPromise().then((t => (s.raiseOnCommittedEvent(), 
        t)));
    }
    Gi(t, e) {
        return gi.or(Object.values(this.Li).map((n => () => n.containsKey(t, e))));
    }
}
...
class Vo {
    ...
    addReference(t, e, n) {
        return this.Qi.addReference(n, e), this.zi.delete(n.toString()), gi.resolve();
    }
    removeReference(t, e, n) {
        return this.Qi.removeReference(n, e), this.zi.add(n.toString()), gi.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.zi.add(e.toString()), gi.resolve();
    }
    removeTarget(t, e) {
    ...
    Hi(t, e) {
        return gi.or([ () => gi.resolve(this.Qi.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Gi(t, e) ]);
    }
}
...
class Co {
     ...
     */    static Ji(t, e, n) {
        ...
        r && (i = new j(s.error.code, s.error.message))), r ? new Co(t, e, s.state, i) : ($("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Yi() {
        const t = {
...
class xo {
     ...
     */    static Ji(t, e) {
        ...
        i && (s = new j(n.error.code, n.error.message))), i ? new xo(t, n.state, s) : ($("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Yi() {
        const t = {
 ...
 */ class No {
     ...
     */    static Ji(t, e) {
        ...
        return s ? new No(t, i) : ($("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class ko {
     ...
     */    static Ji(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new ko(e.clientId, e.onlineState) : ($("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Oo {
    constructor(t, e, n, s, i) {
        ...
        this.sr = new Fn(ot), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.rr = vo(this.persistenceKey, this.tr), 
        this.ur = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.sr = this.sr.insert(this.tr, new Mo), this.ar = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    async start() {
        ...
        for (const e of t) {
            ...
            const t = this.getItem(vo(this.persistenceKey, e));
            if (t) {
                const n = No.Ji(e, t);
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(Do(this.persistenceKey, t));
            if (n) {
                const s = xo.Ji(t, n);
                s && (e = s.state);
            }
 ...
 */ (e.newValue);
    ...
    yr(t, e, n) {
        const s = new Co(this.currentUser, t, e, n), i = So(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Yi());
    }
    pr(t) {
    ...
    Tr(t, e, n) {
        const s = Do(this.persistenceKey, t), i = new xo(t, e, n);
        this.setItem(s, i.Yi());
    }
    Ar(t) {
...
class Fo {
    constructor() {
        this.Fr = new Mo, this.$r = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.Fr = new Mo, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    ro(t, e, n, s, i) {
        ...
        const o = {};
        return this.uo(o, s, i), this.ao(t, r, o, n).then((t => (F("RestConnection", "Received: ", t), 
        t)), (e => {
    ...
    ho(t, e, n) {
        const s = [ this.so, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = P(), r = b(), o = {
 ...
 * limitations under the License.
 */ function Qo(t) {
    return new hs(t, /* useProto3Json= */ !0);
}
...
class Wo {
    constructor(t, e, n, s, i, r, o, u) {
        this.Jn = t, this.Ao = n, this.Ro = s, this.Po = i, this.authCredentialsProvider = r, 
         ...
         * close.
         */
        this.bo = 0, this.Vo = null, this.vo = null, this.stream = null, this.So = new jo(t, e);
    }
    /**
    ...
    auth() {
        ...
        const t = this.Lo(this.bo), e = this.bo;
     ...
     */    Lo(t) {
        return e => {
            this.Jn.enqueueAndForget((() => this.bo === t ? e() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class zo extends Wo {
    ...
    Ko(t, e) {
        return this.Po.ho("Listen", t, e);
    }
    onMessage(t) {
        // A successful response means the stream is healthy
        this.So.reset();
        const e = bs(this.M, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return ht.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? ht.min() : e.readTime ? _s(e.readTime) : ht.min();
        }(t);
     ...
     */    Qo(t) {
        const e = {};
        e.database = Ts(this.M), e.addTarget = function(t, e) {
            let n;
            const s = e.target;
            return n = ge(s) ? {
                documents: Ds(t, s)
                ...
                query: Cs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = fs(t, e.resumeToken) : e.snapshotVersion.compareTo(ht.min()) > 0 && (
     ...
     */    jo(t) {
        const e = {};
        e.database = Ts(this.M), e.removeTarget = t, this.Oo(e);
    }
}
 ...
 */ class Ho extends Wo {
    ...
    onMessage(t) {
        ...
        q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Wo) {
            ...
            this.So.reset();
            const e = Ss(t.writeResults, t.commitTime), n = _s(t.commitTime);
     ...
     */    Xo() {
        ...
        const t = {};
        t.database = Ts(this.M), this.Oo(t);
    }
...
class Jo extends class {} {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    ro(t, e, n) {
        return this.tu(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([s, i]) => this.Po.ro(t, e, n, s, i))).catch((t => {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */    co(t, e, n) {
        return this.tu(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([s, i]) => this.Po.co(t, e, n, s, i))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === Q.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), t) : new j(Q.UNKNOWN, t.toString());
        }));
    }
    ...
    e, n, s, i) {
        ...
        this.fu = [], this.du = i, this.du.Br((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                uu(this) && (F("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = G(t);
                    e.lu.add(4 /* ConnectivityChange */), await tu(e), e._u.set("Unknown" /* Unknown */), 
                    e.lu.delete(4 /* ConnectivityChange */), await Zo(e);
                }(this));
            }));
        })), this._u = new Yo(n, s);
    }
...
async function Zo(t) {
    if (uu(t)) for (const e of t.fu) await e(/* enabled= */ !0);
}
 ...
 */ function nu(t, e) {
    const n = G(t), s = Pu(n);
    n.hu.delete(e), s.Co() && iu(n, e), 0 === n.hu.size && (s.Co() ? s.ko() : uu(n) && 
 ...
 */ function ou(t) {
    return uu(t) && !Pu(t).Do() && t.hu.size > 0;
}
...
async function lu(t, e, n) {
    ...
    t._u.set("Online" /* Online */), e instanceof ss && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await fu(t, n);
    } else if (e instanceof es ? t.wu.ut(e) : e instanceof ns ? t.wu._t(e) : t.wu.ht(e), 
    !n.isEqual(ht.min())) try {
        const e = await io(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new xi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                su(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        F("RemoteStore", "Failed to raise snapshot:", e), await fu(t, e);
    }
}
 ...
 */ async function fu(t, e, n) {
    ...
    await tu(t), t._u.set("Offline" /* Offline */), n || (
...
async function _u(t) {
    ...
    for (;wu(e); ) try {
        const t = await uo(e.localStore, s);
        if (null === t) {
            0 === e.cu.length && n.ko();
            break;
        }
...
function gu(t) {
    return uu(t) && !bu(t).Do() && t.cu.length > 0;
}
...
async function Tu(t, e, n) {
    const s = t.cu.shift(), i = Di.from(s, e, n);
    await du(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
...
async function Eu(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, kn(n) && n !== Q.ABORTED) {
            ...
            // restart.
                        bu(t).No(), await du(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function Au(t, e) {
    ...
    // new mutations from the LocalStore (since mutations are per-user).
        n.lu.add(3 /* CredentialChange */), await tu(n), s && 
    // Don't set the network status to Unknown if we are offline.
    n._u.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
    n.lu.delete(3 /* CredentialChange */), await Zo(n);
}
 ...
 */ async function Ru(t, e) {
    const n = G(t);
    e ? (n.lu.delete(2 /* IsSecondary */), await Zo(n)) : e || (n.lu.add(2 /* IsSecondary */), 
    await tu(n), n._u.set("Unknown" /* Unknown */));
}
 ...
 */ function Pu(t) {
    ...
    t.mu = function(t, e, n) {
        const s = G(t);
        return s.tu(), new zo(e, s.Po, s.authCredentials, s.appCheckCredentials, s.M, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.mu.No(), ou(t) ? ru(t) : t._u.set("Unknown" /* Unknown */)) : (await t.mu.stop(), 
        au(t));
    }))), t.mu;
}
 ...
 */ function bu(t) {
    ...
    t.gu = function(t, e, n) {
        const s = G(t);
        return s.tu(), new Ho(e, s.Po, s.authCredentials, s.appCheckCredentials, s.M, n);
    }(t.datastore, t.asyncQueue, {
        zr: pu.bind(null, t),
        Jr: Eu.bind(null, t),
        Yo: Iu.bind(null, t),
        ...
        await _u(t)) : (await t.gu.stop(), t.cu.length > 0 && (F("RemoteStore", `Stopping write stream with ${t.cu.length} pending writes`), 
        t.cu = []));
    }))), t.gu;
}
 ...
 */ function vu(t, e) {
    if ($("AsyncQueue", `${e}: ${t}`), Ei(t)) return new j(Q.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Su {
    ...
    constructor(t) {
        ...
        this.keyedMap = jn(), this.sortedSet = new Fn(this.comparator);
    }
    /**
     * Returns an empty copy of the existing DocumentSet, using the same
     * comparator.
     */    static emptySet(t) {
        return new Su(t.comparator);
    }
    has(t) {
...
class Cu {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Cu(t, e, Su.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && Ge(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs))) return !1;
...
class Nu {
    constructor() {
        this.queries = new On((t => Qe(t)), Ge), this.onlineState = "Unknown" /* Unknown */ , 
        this.Tu = new Set;
    }
}
...
async function ku(t, e) {
    ...
    if (r || (i = !0, r = new xu), i) try {
        r.Iu = await n.onListen(s);
    } catch (t) {
        const n = vu(t, `Initialization of query '${je(e.query)}' failed`);
 ...
 */ class Bu {
    constructor(t, e, n) {
         ...
         */
        this.Pu = !1, this.bu = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {};
    }
    /**
     ...
     */    Au(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Cu(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
            /* excludesMetadataChanges= */ !0);
        }
        let e = !1;
        return this.Pu ? this.Vu(t) && (this.Ru.next(t), e = !0) : this.vu(t, this.onlineState) && (this.Su(t), 
        e = !0), this.bu = t, e;
    }
    onError(t) {
        this.Ru.error(t);
    ...
    /** Returns whether a snapshot was raised. */    Eu(t) {
        this.onlineState = t;
        let e = !1;
        return this.bu && !this.Pu && this.vu(this.bu, t) && (this.Su(this.bu), e = !0), 
        e;
    }
    vu(t, e) {
    ...
    Su(t) {
        t = Cu.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Pu = !0, 
        this.Ru.next(t);
    }
}
 ...
 */ class Uu {
     ...
     */    fi(t) {
        return t.metadata.exists ? Rs(this.M, t.document, !1) : ne.newNoDocument(this.li(t.metadata.name), this.di(t.metadata.readTime));
    }
    di(t) {
        return _s(t);
    }
 ...
 */ class qu {
    constructor(t, e, n) {
        ...
        this.collectionGroups = new Set, this.progress = Ku(t);
    }
    /**
    ...
    ku(t) {
        const e = new Map, n = new Uu(this.M);
        for (const s of t) if (s.metadata.queries) {
            const t = n.li(s.metadata.name);
            for (const n of s.metadata.queries) {
                const s = (e.get(n) || Jn()).add(t);
                e.set(n, s);
            }
        }
        return e;
     ...
     */    async complete() {
        const t = await wo(this.localStore, new Uu(this.M), this.documents, this.xu.id), e = this.ku(this.documents);
        for (const t of this.queries) await mo(this.localStore, t, e.get(t.name));
 ...
 */ class ju {
    ...
    e) {
        ...
        this.mutatedKeys = Jn(), this.Lu = He(t), this.Uu = new Su(this.Lu);
    }
    /**
     ...
     */    Ku(t, e) {
        const n = e ? e.Gu : new Du, s = e ? e.Uu : this.Uu;
        ...
        const u = Oe(this.query) && s.size === this.query.limit ? s.last() : null, a = Fe(this.query) && s.size === this.query.limit ? s.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal(((t, e) => {
            const c = s.get(t), h = We(this.query, e) ? e : null, l = !!c && this.mutatedKeys.has(c.key), f = !!h && (h.hasLocalMutations || 
        ...
        })), Oe(this.query) || Fe(this.query)) for (;r.size > this.query.limit; ) {
 ...
 */ (t.type, e.type) || this.Lu(t.doc, e.doc))), this.ju(n);
        ...
        if (this.$u = o, 0 !== i.length || u) {
            return {
                snapshot: new Cu(this.query, t.Uu, s, i, t.mutatedKeys, 0 /* Local */ === o, u, 
                /* excludesMetadataChanges= */ !1),
                zu: r
            };
        }
    ...
    Wu() {
        ...
        // updating many documents.
                const t = this.Bu;
        this.Bu = Jn(), this.Uu.forEach((t => {
            this.Hu(t.key) && (this.Bu = this.Bu.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.Bu.has(t) || e.push(new Qu(t));
        })), this.Bu.forEach((n => {
            t.has(n) || e.push(new Gu(n));
        })), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Yu() {
        return Cu.fromInitialDocuments(this.query, this.Uu, this.mutatedKeys, 0 /* Local */ === this.$u);
    }
}
...
/** Tracks a limbo resolution. */ class zu {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class Hu {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.Zu = {}, this.ta = new On((t => Qe(t)), Ge), 
        this.ea = new Map, 
        /**
         ...
         * active target.
         */
        this.sa = new Fn(kt.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.ia = new Map, this.ra = new po, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.oa = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ua = new Map, this.aa = Rr.gn(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Ju(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Yu(); else {
        const t = await ao(n.localStore, qe(e));
        n.isPrimaryClient && eu(n.remoteStore, t);
        const r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await Yu(n, e, s, "current" === r);
    }
    return i;
}
 ...
 */ async function Yu(t, e, n, s) {
    ...
    t.ha = (e, n, s) => async function(t, e, n, s) {
        ...
        i = await ho(t.localStore, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view.Ku(t, i))));
        const r = s && s.targetChanges.get(e.targetId), o = e.view.applyChanges(i, 
        /* updateLimboDocuments= */ t.isPrimaryClient, r);
        return ha(t, e.targetId, o.zu), o.snapshot;
    }(t, e, n, s);
    const i = await ho(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new ju(e, i.hi), o = r.Ku(i.documents), u = ts.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.applyChanges(o, 
    /* updateLimboDocuments= */ t.isPrimaryClient, u);
    ha(t, n, a.zu);
    const c = new Wu(e, n, r);
    return t.ta.set(e, c), t.ea.has(n) ? t.ea.get(n).push(e) : t.ea.set(n, [ e ]), a.snapshot;
}

/** Stops listening to the query. */ async function Xu(t, e) {
    const n = G(t), s = n.ta.get(e), i = n.ea.get(s.targetId);
    if (i.length > 1) return n.ea.set(s.targetId, i.filter((t => !Ge(t, e)))), void n.ta.delete(e);
    ...
    } else aa(n, s.targetId), await co(n.localStore, s.targetId, 
 ...
 */ async function Zu(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = G(t), s = ct.now(), i = e.reduce(((t, e) => t.add(e.key)), Jn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.ai.qs(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Pn(t.key, e, ee(e.value.mapValue), mn.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await da(s, t.changes), await _u(s.remoteStore);
    } catch (t) {
        // If we can't persist the mutation, we reject the user callback and
        // don't send the mutation. The user can then retry the write.
        const e = vu(t, "Failed to persist write");
        n.reject(e);
    }
}
 ...
 */ async function na(t, e, n) {
    ...
    if (r) {
        ...
        let t = new Fn(kt.comparator);
        // TODO(b/217189216): This limbo document should ideally have a read time,
        // so that it is picked up by any read-time based scans. The backend,
        // however, does not send a read time for target removals.
                t = t.insert(r, ne.newNoDocument(r, ht.min()));
        const n = Jn().add(r), i = new Zn(ht.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new Ln(ot), t, n);
        await ta(s, i), 
        ...
        s.sa = s.sa.remove(r), s.ia.delete(e), fa(s);
    } else await co(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => aa(s, e, n))).catch(Sr);
}
...
async function sa(t, e) {
    ...
    try {
        ...
        // before listen events.
                ua(n, s, /*error=*/ null), oa(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await da(n, t);
    } catch (t) {
        await Sr(t);
    }
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.$s.lookupMutationBatch(t, e).next((e => (q(null !== e), s = e.keys(), n.$s.removeMutationBatch(t, e)))).next((() => n.$s.performConsistencyCheck(t))).next((() => n.ai.qs(t, s)));
            }));
        }
        /**
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                ua(s, e, n), oa(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await da(s, t);
    } catch (n) {
        await Sr(n);
    }
 ...
 */ async function ra(t, e) {
    const n = G(t);
    uu(n.remoteStore) || F("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
        ...
        const n = vu(t, "Initialization of waitForPendingWrites() operation failed");
        e.reject(n);
    }
}
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function ua(t, e, n) {
    const s = G(t);
...
function ca(t, e) {
    ...
    const n = t.sa.get(e);
    null !== n && (nu(t.remoteStore, n), t.sa = t.sa.remove(e), t.ia.delete(n), fa(t));
}

function ha(t, e, n) {
    for (const s of n) if (s instanceof Gu) t.ra.addReference(s.key, e), la(t, s); else if (s instanceof Qu) {
        F("SyncEngine", "Document no longer in limbo: " + s.key), t.ra.removeReference(s.key, e);
...
function la(t, e) {
    ...
    t.sa.get(n) || t.na.has(s) || (F("SyncEngine", "New document in limbo: " + n), t.na.add(s), 
    fa(t));
}
 ...
 */ function fa(t) {
    for (;t.na.size > 0 && t.sa.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.na.delete(e);
        const n = new kt(wt.fromString(e)), s = t.aa.next();
        t.ia.set(s, new zu(n)), t.sa = t.sa.insert(n, s), eu(t.remoteStore, new xi(qe(Me(n.path)), s, 2 /* LimboResolution */ , st.A));
    }
}
...
async function da(t, e, n) {
    ...
    s.ta.isEmpty() || (s.ta.forEach(((t, u) => {
        ...
        const n = G(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => gi.forEach(e, (e => gi.forEach(e.zs, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => gi.forEach(e.Hs, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Ei(t)) throw t;
...
async function _a(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        const t = await no(n.localStore, e);
        n.currentUser = e, 
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await da(n, t.ci);
    }
}

function wa(t, e) {
    const n = G(t), s = n.ia.get(e);
    if (s && s.Xu) return Jn().add(s.key);
    {
        let t = Jn();
        const s = n.ea.get(e);
        if (!s) return t;
 ...
 */ async function ma(t, e) {
    const n = G(t), s = await ho(n.localStore, e.query, 
    /* usePreviousResults= */ !0), i = e.view.Ju(s);
    return n.isPrimaryClient && ha(n, e.targetId, i.zu), i;
}
...
async function ga(t, e) {
    const n = G(t);
    return fo(n.localStore, e).then((t => da(n, t)));
}

/** Applies a mutation state to an existing batch.  */
// PORTING NOTE: Multi-Tab only.
async function ya(t, e, n, s) {
    const i = G(t), r = await function(t, e) {
        const n = G(t), s = G(n.$s);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.ln(t, e).next((e => e ? n.ai.qs(t, e) : gi.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await _u(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    ua(i, e, s || null), oa(i, e), function(t, e) {
        G(G(t).$s).dn(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : U(), await da(i, r)) : 
...
async function pa(t, e) {
    ...
    if (Pa(n), ba(n), !0 === e && !0 !== n.ca) {
        ...
        n.ca = !0, await Ru(n.remoteStore, !0);
        for (const t of e) eu(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.ca) {
        const t = [];
        ...
        function(t) {
            ...
            e.ia.forEach(((t, n) => {
                nu(e.remoteStore, n);
            })), e.ra.Pi(), e.ia = new Map, e.sa = new Fn(kt.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.ca = !1, await Ru(n.remoteStore, !1);
    }
}
...
async function Ia(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await ao(s.localStore, qe(n[0]));
            for (const t of n) {
                const e = s.ta.get(t), n = await ma(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await lo(s.localStore, t);
            e = await ao(s.localStore, n), await Yu(s, Ta(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
// PORTING NOTE: Multi-Tab only.
function Ta(t) {
    return ke(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
}
...
async function Aa(t, e, n, s) {
    ...
    if (r && r.length > 0) switch (n) {
      ...
      case "not-current":
        {
            const t = await fo(i.localStore, ze(r[0])), s = Zn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await da(i, t, s);
            break;
        }
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Ra(t, e, n) {
    const s = Pa(t);
    if (s.ca) {
        for (const t of e) {
            if (s.ea.has(t)) {
            ...
            const e = await lo(s.localStore, t), n = await ao(s.localStore, e);
            await Yu(s, Ta(e), n.targetId, 
            /*current=*/ !1), eu(s.remoteStore, n);
        }
        for (const t of n) 
...
function Pa(t) {
    const e = G(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = ta.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = wa.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = na.bind(null, e), e.Zu.Go = Ou.bind(null, e.eventManager), 
    e.Zu.la = Fu.bind(null, e.eventManager), e;
}

function ba(t) {
    const e = G(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = sa.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ia.bind(null, e), 
    e;
}
 ...
 */ (t.localStore, s)) return await e.close(), n._completeWith(function(t) {
            ...
            n._updateProgress(Ku(s));
            const i = new qu(s, t.localStore, e.M);
            let r = await e.fa();
            for (;r; ) {
...
class va {
    ...
    async initialize(t) {
        this.M = Qo(t.databaseInfo.databaseId), this.sharedClientState = this.da(t), this.persistence = this._a(t), 
    ...
    ma(t) {
        return eo(this.persistence, new Zr, t.initialUser, this.M);
    }
    _a(t) {
        return new Po(Vo.Wi, this.M);
    }
    da(t) {
        return new Fo;
    }
 ...
 */ class Sa extends va {
    ...
    async initialize(t) {
        ...
        await ba(this.ga.syncEngine), await _u(this.ga.remoteStore), 
    ...
    wa(t) {
        ...
        return new xr(e, t.asyncQueue);
    }
    _a(t) {
        const e = Jr(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? mr.withCacheSize(this.cacheSizeBytes) : mr.DEFAULT;
        return new Wr(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Ko(), Go(), this.M, this.sharedClientState, !!this.forceOwnership);
    }
    da(t) {
        return new Fo;
    }
 ...
 */ class Da extends Sa {
    ...
    async initialize(t) {
        ...
        this.sharedClientState instanceof Oo && (this.sharedClientState.syncEngine = {
            kr: ya.bind(null, e),
            Mr: Aa.bind(null, e),
            Or: Ra.bind(null, e),
            Os: Ea.bind(null, e),
        ...
        await this.persistence.Is((async t => {
            await pa(this.ga.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    da(t) {
        const e = Ko();
        if (!Oo.vt(e)) throw new j(Q.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = Jr(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Oo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class Ca {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => ea(this.syncEngine, t, 1 /* SharedClientState */), 
        this.remoteStore.remoteSyncer.handleCredentialChange = _a.bind(null, this.syncEngine), 
        await Ru(this.remoteStore, this.syncEngine.isPrimaryClient));
    }
    createEventManager(t) {
        return new Nu;
    }
    createDatastore(t) {
        const e = Qo(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new qo(s));
        var s;
        /** Return the Platform-specific connectivity monitor. */        return function(t, e, n, s) {
            return new Jo(t, e, n, s);
        }(t.authCredentials, t.appCheckCredentials, n, e);
    }
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => ea(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Bo.vt() ? new Bo : new $o, new Xo(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = G(t);
            F("RemoteStore", "RemoteStore shutting down."), e.lu.add(5 /* Shutdown */), await tu(e), 
            e.du.shutdown(), 
 ...
 */ class ka {
     ...
     */    async Ea() {
        ...
        return new Lu(JSON.parse(s), t.length + n);
    }
    /** First index of '{' from the underlying buffer. */    ba() {
...
class Ma {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = G(t), s = Ts(n.M) + "/documents", i = {
                documents: e.map((t => gs(n.M, t)))
    ...
    delete(t) {
        this.write(new Sn(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? mn.updateTime(e) : mn.none();
    }
    /**
...
class Oa {
    constructor(t, e, n, s) {
        ...
        this.va = 5, this.So = new jo(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Sa() {
        this.So.Io((async () => {
            const t = new Ma(this.datastore), e = this.Da(t);
            e && e.then((e => {
    ...
    terminate() {
        ...
        return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async () => {
            try {
                ...
                const n = vu(e, "Failed to shutdown persistence");
                t.reject(n);
            }
        })), t.promise;
    }
...
async function $a(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await no(e.localStore, t), s = t);
    })), 
...
async function Ba(t, e) {
    ...
    t.setCredentialChangeListener((t => Au(e.remoteStore, t))), t.setAppCheckTokenChangeListener(((t, n) => Au(e.remoteStore, n))), 
    t.onlineComponents = e;
}

async function La(t) {
    return t.offlineComponents || (F("FirestoreClient", "Using default OfflineComponentProvider"), 
    await $a(t, new va)), t.offlineComponents;
}

async function Ua(t) {
    return t.onlineComponents || (F("FirestoreClient", "Using default OnlineComponentProvider"), 
    await Ba(t, new Ca)), t.onlineComponents;
}
...
function Ga(t) {
    return Ua(t).then((t => t.remoteStore));
}

function Qa(t) {
    return Ua(t).then((t => t.syncEngine));
}

async function ja(t) {
    const e = await Ua(t), n = e.eventManager;
    return n.onListen = Ju.bind(null, e.syncEngine), n.onUnlisten = Xu.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function Wa(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await qa(t), n = await Ga(t);
        return e.setNetworkEnabled(!0), function(t) {
            const e = G(t);
            return e.lu.delete(0 /* UserDisabled */), Zo(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function za(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = G(t);
            e.lu.add(0 /* UserDisabled */), await tu(e), 
 ...
 */ function Ha(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            const s = vu(t, `Failed to get document '${e} from cache`);
            n.reject(s);
        }
    }
    /**
...
function Ya(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            const s = await ho(t, e, 
            /* usePreviousResults= */ !0), i = new ju(e, s.hi), r = i.Ku(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
            n.resolve(o.snapshot);
        } catch (t) {
            const s = vu(t, `Failed to execute query '${e} against cache`);
            n.reject(s);
        }
    }
    /**
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Na({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Mu(t, o))), n.fromCache && "server" === s.source ? i.reject(new j(Q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Bu(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function tc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => {
        const s = await function(t) {
            return Ua(t).then((t => t.datastore));
        }(t);
        new Oa(t.asyncQueue, s, e, n).run();
    })), n.promise;
}
 ...
 */
        return function(t) {
            const e = sc.get(t);
            e && (F("ComponentProvider", "Removing Datastore"), sc.delete(t), e.terminate());
...
function dc(t, e, n, s = {}) {
    var i;
    const r = (t = cc(t, fc))._getSettings();
 ...
 */ class _c {
     ...
     */    get parent() {
        return new mc(this.firestore, this.converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new _c(this.firestore, t, this._key);
    }
}
 ...
 */ class wc {
    ...
    withConverter(t) {
        return new wc(this.firestore, t, this._query);
    }
}
 ...
 */ class mc extends wc {
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new _c(this.firestore, 
        /* converter= */ null, new kt(t));
    }
    withConverter(t) {
        return new mc(this.firestore, t, this._path);
    }
}
...
function gc(t, e, ...n) {
    if (t = I(t), ic("collection", "path", e), t instanceof fc) {
        ...
        return uc(s), new mc(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof _c || t instanceof mc)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(wt.fromString(e, ...n));
        return uc(s), new mc(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function yc(t, e) {
    if (t = cc(t, fc), ic("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new j(Q.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new wc(t, 
    /* converter= */ null, 
    /**
...
function pc(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = rt.R()), ic("doc", "path", e), t instanceof fc) {
        const s = wt.fromString(e, ...n);
        return oc(s), new _c(t, 
        /* converter= */ null, new kt(s));
    }
    {
        if (!(t instanceof _c || t instanceof mc)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(wt.fromString(e, ...n));
        return oc(s), new _c(t.firestore, t instanceof mc ? t.converter : null, new kt(s));
    }
}
 ...
 * Firestore database.
 */ function Ic(t, e) {
    return t = I(t), e = I(e), (t instanceof _c || t instanceof mc) && (e instanceof _c || e instanceof mc) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Tc(t, e) {
    return t = I(t), e = I(e), t instanceof wc && e instanceof wc && (t.firestore === e.firestore && Ge(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Ec {
    constructor() {
        ...
        this.So = new jo(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new W;
        return this.Ka((() => this.Ma && this.Ba ? Promise.resolve() : (t().then(e.resolve, e.reject), 
        e.promise))).then((() => e.promise));
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.ka.push(t), this.Ga())));
    }
    /**
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Vu.createAndSchedule(this, t, e, n, (t => this.Qa(t)));
...
class bc extends fc {
    ...
    constructor(t, e, n) {
         ...
         */
        this.type = "firestore", this._queue = new Ec, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
        return this._firestoreClient || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        Dc(this), this._firestoreClient.terminate();
    }
}
 ...
 * @internal
 */ function Sc(t) {
    return t._firestoreClient || Dc(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}
...
function Dc(t) {
    ...
    t._firestoreClient = new Fa(t._authCredentials, t._appCheckCredentials, t._queue, s);
}
 ...
 */ function Cc(t, e) {
    Uc(t = cc(t, bc));
    const n = Sc(t), s = t._freezeSettings(), i = new Ca;
    return Nc(n, i, new Sa(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function xc(t) {
    Uc(t = cc(t, bc));
    const e = Sc(t), n = t._freezeSettings(), s = new Ca;
    return Nc(e, s, new Da(s, n.cacheSizeBytes));
}
 ...
 */ function Nc(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await $a(t, n), await Ba(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function kc(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!pi.vt()) return Promise.resolve();
                const e = t + "main";
                await pi.delete(e);
            }(Jr(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function Mc(t) {
    return function(t) {
        const e = new W;
        return t.asyncQueue.enqueueAndForget((async () => ra(await Qa(t), e))), e.promise;
    }(Sc(t = cc(t, bc)));
}
 ...
 */ function Bc(t, e) {
    const n = Sc(t = cc(t, bc)), s = new Rc;
    return ec(n, t._databaseId, e, s), s;
}
 ...
 */ function Lc(t, e) {
    return nc(Sc(t = cc(t, bc)), e).then((e => e ? new wc(t, null, e.query) : null));
}
 ...
 */ class Gc {
     ...
     */    static fromBase64String(t) {
        try {
            return new Gc(Tt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Gc(Tt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class zc {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new Pn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Rn(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Hc {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class Yc {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    Xa(t) {
        return new Yc(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.M, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    Za(t) {
        var e;
    ...
    ic(t) {
        return gh(t, this.settings.methodName, this.settings.rc || !1, this.path, this.settings.oc);
    }
    ...
    ec(t) {
        ...
        if (Jc(this.Ya) && Wc.test(t)) throw this.ic('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Xc {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || Qo(t);
    }
...
function Zc(t) {
    const e = t._freezeSettings(), n = Qo(t._databaseId);
    return new Xc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function th(t, e, n, s, i, r = {}) {
    const o = t.uc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    dh("Data must be an object, but it was:", o, s);
    const u = lh(s, o);
    let a, c;
...
class ih extends Qc {
    ...
    _toFieldTransform(t) {
        const e = nh(this, t, 
        /*array=*/ !0), n = this.ac.map((t => hh(t, e))), s = new on(n);
        return new dn(t.path, s);
    }
    isEqual(t) {
...
class rh extends Qc {
    ...
    _toFieldTransform(t) {
        const e = nh(this, t, 
        /*array=*/ !0), n = this.ac.map((t => hh(t, e))), s = new an(n);
        return new dn(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class oh extends Qc {
    ...
    _toFieldTransform(t) {
        const e = new hn(t.M, Ze(t.M, this.cc));
        return new dn(t.path, e);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
...
/** Parse update data from an update() call. */ function uh(t, e, n, s) {
    ...
    dh("Data must be an object, but it was:", i, s);
    const r = [], o = te.empty();
    ft(s, ((t, s) => {
        const u = mh(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function ah(t, e, n, s, i, r) {
    ...
    for (let t = 0; t < r.length; t += 2) u.push(_h(e, r[t])), a.push(r[t + 1]);
    const c = [], h = te.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = u.length - 1; t >= 0; --t) if (!yh(c, u[t])) {
        const e = u[t];
        let n = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function ch(t, e, n, s = !1) {
    return hh(n, t.uc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function hh(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return dh("Unsupported field value:", e, t), lh(t, e);
    if (t instanceof Qc) 
 ...
 */
    return function(t, e) {
        ...
        if (!Jc(e.Ya)) throw e.ic(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Ze(e.M, t);
        ...
        if (t instanceof Gc) return {
            bytesValue: fs(e.M, t._byteString)
        };
        if (t instanceof _c) {
            ...
            return {
                referenceValue: ws(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.ic(`Unsupported field value: ${ac(t)}`);
    }
    /**
...
function fh(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ct || t instanceof jc || t instanceof Gc || t instanceof _c || t instanceof Qc);
}
 ...
 */ function _h(t, e, n) {
    ...
    if ("string" == typeof e) return mh(t, e);
    throw gh("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function mh(t, e, n) {
    if (e.search(wh) >= 0) throw gh(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new qc(...e.split("."))._internalPath;
    } catch (s) {
        throw gh(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}

function gh(t, e, n, s, i) {
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function yh(t, e) {
 ...
 */ class ph {
     ...
     */    get ref() {
        return new _c(this._firestore, this._converter, this._key);
    }
    /**
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Ih(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Th("DocumentSnapshot.get", t));
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Th(t, e) {
    return "string" == typeof e ? mh(t, e) : e instanceof qc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class Ah extends ph {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new Rh(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Th("DocumentSnapshot.get", t));
 ...
 */ class Ph {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Eh(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Rh(this._firestore, this._userDataWriter, n.key, n, new Eh(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Rh(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Eh(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Rh(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Eh(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function vh(t) {
    if (Fe(t) && 0 === t.explicitOrderBy.length) throw new j(Q.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Ch extends Sh {
    ...
    _apply(t) {
        const e = Zc(t.firestore), n = function(t, e, n, s, i, r, o) {
            let u;
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    jh(o, r);
                    const e = [];
                    for (const n of o) e.push(Qh(s, t, n));
                    u = {
                        arrayValue: {
                            values: e
                        }
 ...
 */
        ...
        return new wc(t.firestore, t.converter, function(t, e) {
...
class Mh extends Sh {
    ...
    _apply(t) {
        return new wc(t.firestore, t.converter, Ke(t._query, this._c, this.wc));
    }
}
 ...
 * @returns The created {@link Query}.
 */ function Oh(t) {
    return hc("limit", t), new Mh("limit", t, "F" /* First */);
}
 ...
 * @returns The created {@link Query}.
 */ function Fh(t) {
    return hc("limitToLast", t), new Mh("limitToLast", t, "L" /* Last */);
}
...
class $h extends Sh {
    ...
    _apply(t) {
        const e = Gh(t, this.type, this.mc, this.gc);
        return new wc(t.firestore, t.converter, function(t, e) {
...
function qh(...t) {
    return new Uh("endBefore", t, 
    /*inclusive=*/ !1);
}

function Kh(...t) {
    return new Uh("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function Gh(t, e, n, s) {
    if (n[0] = I(n[0]), n[0] instanceof ph) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Ue(t)) if (n.field.isKeyField()) r.push(Gt(e, s.key)); else {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!Le(t) && -1 !== a.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
...
function Qh(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!Le(e) && -1 !== n.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    ...
    if (n instanceof _c) return Gt(t, n._key);
    throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${ac(n)}.`);
}
...
class Jh extends zh {
    ...
    convertReference(t) {
        ...
        return new _c(this.firestore, /* converter= */ null, e);
    }
}
 ...
 */ class Yh {
    ...
    set(t, e, n) {
        ...
        const s = Xh(t, this._firestore), i = Hh(s.converter, e, n), r = th(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, mn.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = Xh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof qc ? ah(this._dataReader, "WriteBatch.update", i._key, e, n, s) : uh(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, mn.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = Xh(t, this._firestore);
        return this._mutations = this._mutations.concat(new Sn(e._key, mn.none())), this;
    }
    /**
...
function Zh(t) {
    t = cc(t, _c);
    const e = cc(t.firestore, bc);
    return Ja(Sc(e), t._key).then((n => dl(e, t, n)));
}
 ...
 */ function el(t) {
    t = cc(t, _c);
    const e = cc(t.firestore, bc), n = Sc(e), s = new tl(e);
    return Ha(n, t._key).then((n => new Ah(e, s, t._key, n, new Eh(null !== n && n.hasLocalMutations, 
 ...
 */ function sl(t) {
    t = cc(t, wc);
    const e = cc(t.firestore, bc), n = Sc(e), s = new tl(e);
    return vh(t._query), Xa(n, t._query).then((n => new Ph(e, s, t, n)));
}
 ...
 */ function il(t) {
    t = cc(t, wc);
    const e = cc(t.firestore, bc), n = Sc(e), s = new tl(e);
    return Ya(n, t._query).then((n => new Ph(e, s, t, n)));
}
...
function ol(t, e, n) {
    t = cc(t, _c);
    const s = cc(t.firestore, bc), i = Hh(t.converter, e, n);
    return fl(s, [ th(Zc(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, mn.none()) ]);
}

function ul(t, e, n, ...s) {
    t = cc(t, _c);
    const i = cc(t.firestore, bc), r = Zc(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof qc ? ah(r, "updateDoc", t._key, e, n, s) : uh(r, "updateDoc", t._key, e);
    return fl(i, [ o.toMutation(t._key, mn.exists(!0)) ]);
}
 ...
 */ function al(t) {
    return fl(cc(t.firestore, bc), [ new Sn(t._key, mn.none()) ]);
}
 ...
 */ function cl(t, e) {
    const n = cc(t.firestore, bc), s = pc(t), i = Hh(t.converter, e);
    return fl(n, [ th(Zc(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, mn.exists(!1)) ]).then((() => s));
}
...
function hl(t, ...e) {
    ...
    "object" != typeof e[o] || Ac(e[o]) || (r = e[o], o++);
    const u = {
    ...
    let a, c, h;
    if (t instanceof _c) c = cc(t.firestore, bc), h = Me(t._key.path), a = {
        next: n => {
            e[o] && e[o](dl(c, t, n));
        },
        error: e[o + 1],
        ...
        const n = cc(t, wc);
        c = cc(n.firestore, bc), h = n._query;
        const s = new tl(c);
        a = {
            next: t => {
    ...
    return function(t, e, n, s) {
        const i = new Na(s), r = new Bu(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => ku(await ja(t), r))), () => {
            i.pa(), t.asyncQueue.enqueueAndForget((async () => Mu(await ja(t), r)));
        };
    }(Sc(c), h, u, a);
}

function ll(t, e) {
    return Za(Sc(t = cc(t, bc)), Ac(e) ? e : {
        next: e
    });
}
 ...
 */ function fl(t, e) {
    return function(t, e) {
        const n = new W;
        return t.asyncQueue.enqueueAndForget((async () => Zu(await Qa(t), e, n))), n.promise;
    }(Sc(t), e);
}
 ...
 */ function dl(t, e, n) {
    const s = n.docs.get(e._key), i = new tl(t);
    return new Ah(t, i, e._key, s, new Eh(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class _l extends class {
     ...
     */    get(t) {
        const e = Xh(t, this._firestore), n = new Jh(this._firestore);
    ...
    set(t, e, n) {
        const s = Xh(t, this._firestore), i = Hh(s.converter, e, n), r = th(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof qc ? ah(this._dataReader, "Transaction.update", i._key, e, n, s) : uh(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = Xh(t, this._firestore), n = new tl(this._firestore);
        return super.get(t).then((t => new Ah(this._firestore, n, e._key, t._document, new Eh(
        /* hasPendingWrites= */ !1, 
 ...
 */ function wl(t, e) {
    return tc(Sc(t = cc(t, bc)), (n => e(new _l(t, n))));
}
 ...
 * writes.
 */ function Tl(t) {
    return Sc(t = cc(t, bc)), new Yh(t, (e => fl(t, e)));
}
 ...
 */ function El(t, e) {
    ...
    if (Array.isArray(n.indexes)) for (const t of n.indexes) {
        const e = Al(t, "collectionGroup"), n = [];
        if (Array.isArray(t.fields)) for (const e of t.fields) {
            const t = mh("setIndexConfiguration", Al(e, "fieldPath"));
