...
import { FirebaseError as f, getUA as d, isSafari as p, isMobileCordova as y, isReactNative as v, isElectron as m, isIE as g, isUWP as w, isBrowserExtension as b, getModularInstance as I, createMockUserToken as E, deepEqual as T, isIndexedDBAvailable as S } from "@firebase/util";

import { XhrIo as _, EventType as N, ErrorCode as D, createWebChannelTransport as A, getStatEventTarget as C, FetchXmlHttpFactory as x, WebChannel as k, Event as M, Stat as V } from "@firebase/webchannel-wrapper";
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (z("string" == typeof n.accessToken), new $(n.accessToken, t.currentUser)) : null;
...
/** Returns the lowest value for the given value type (inclusive). */ function te(t, e) {
    return void 0 === t ? e : void 0 === e || Gt(t, e) > 0 ? t : e;
}
 ...
 */ var ne = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!$t(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.delete = function(t) {
        ...
        $t(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }, t.prototype.isEqual = function(t) {
...
var ie = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , dt.min(), dt.min(), ne.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, dt.min(), ne.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, dt.min(), ne.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
/** Returns a debug representation of the field index */ oe.UNKNOWN_ID = -1;
...
function le(t, e) {
    ...
    return new fe(i, Pt.empty(), e);
}

/** Creates a new offset based on the provided document. */ function he(t) {
...
function me(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!ke(t.orderBy[n], e.orderBy[n])) return !1;
...
/** Returns the field filters that target the given field path. */ function we(t, e) {
    return t.filters.filter((function(t) {
        return t instanceof be && t.field.isEqual(e);
    }));
}
 ...
 */ var be = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.V(t, e, r) : new Ie(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new _e(t, r) : "in" /* IN */ === e ? new Ne(t, r) : "not-in" /* NOT_IN */ === e ? new De(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ae(t, r) : new n(t, e, r);
    }, n.V = function(t, e, n) {
        return "in" /* IN */ === e ? new Ee(t, n) : new Te(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.v(Gt(e, this.value)) : null !== e && qt(this.value) === qt(e) && this.v(Gt(e, this.value));
...
/** A Filter that implements the array-contains operator. */ var _e = /** @class */ function(e) {
    function n(t, n) {
...
}, xe = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function ke(t, e) {
...
function Me(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? Pt.comparator(Pt.fromName(s.referenceValue), n.key) : Gt(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function Le(t, e, n, r, i, o, s, u) {
    return new Re(t, e, n, r, i, o, s, u);
}
 ...
 */ function Ke(t) {
    var e = W(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = ye(e.path, e.collectionGroup, Ge(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Ge(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new xe(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Ce(e.endAt.position, !e.endAt.inclusive) : null, a = e.startAt ? new Ce(e.startAt.position, !e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.C = ye(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.C;
}
...
function ze(t, e) {
    return me(Ke(t), Ke(e)) && t.limitType === e.limitType;
}
 ...
 */
        ...
        }(t.startAt, Ge(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = Me(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, Ge(t), e));
    }(t, e);
 ...
 */ function Je(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = Ge(t); i < o.length; i++) {
            var s = o[i], u = $e(s, e, n);
            if (0 !== u) return u;
 ...
 */ function nn(t, e, n) {
    ...
    }(n, e) : t instanceof un ? an(t, e) : t instanceof cn ? ln(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = on(t, e), r = fn(n) + fn(t.k);
        return Wt(n) && Wt(t.k) ? Ze(r) : Xe(t.M, r);
    }(t, e);
}
 ...
 */ function rn(t, e, n) {
    ...
    // applications.
    return t instanceof un ? an(t, e) : t instanceof cn ? ln(t, e) : n;
}
 ...
 */ function on(t, e) {
    return t instanceof hn ? Wt(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var sn = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var pn = function(t, e) {
 ...
 */ function wn(t, e, n) {
    t instanceof Sn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Dn(t.fieldTransforms, e, n.transformResults);
        ...
        if (mn(t.precondition, e)) {
            var r = Dn(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function bn(t, e, n) {
    t instanceof Sn ? function(t, e, n) {
        ...
        if (mn(t.precondition, e)) {
            var r = An(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Nn(t)), i.setAll(r), e.convertToFoundDocument(Tn(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        mn(t.precondition, e) && 
 ...
 */ function In(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = on(o.transform, s || null);
        null != u && (null == n && (n = ne.empty()), n.set(o.field, u));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && lt(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof un && e instanceof un || t instanceof cn && e instanceof cn ? lt(t.elements, e.elements, Ut) : t instanceof hn && e instanceof hn ? Ut(t.k, e.k) : t instanceof sn && e instanceof sn;
 ...
 */ function An(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, nn(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Cn, xn, kn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (xn = Cn || (Cn = {}))[xn.OK = 0] = "OK", xn[xn.CANCELLED = 1] = "CANCELLED", 
...
var Pn = /** @class */ function() {
    ...
    function t(t, e) {
        this.comparator = t, this.root = e || qn.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, qn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, qn.BLACK, null, null));
    }, 
    ...
    t.prototype.getIterator = function() {
        return new Fn(this.root, null, this.comparator, !1);
    }, t.prototype.getIteratorFrom = function(t) {
        return new Fn(this.root, t, this.comparator, !1);
    }, t.prototype.getReverseIterator = function() {
        return new Fn(this.root, null, this.comparator, !0);
    }, t.prototype.getReverseIteratorFrom = function(t) {
        return new Fn(this.root, t, this.comparator, !0);
    }, t;
}(), Fn = /** @class */ function() {
    function t(t, e, n, r) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
qn.EMPTY = null, qn.RED = !0, qn.BLACK = !1, 
// end LLRBEmptyNode
qn.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var Un = /** @class */ function() {
    function t(t) {
        this.comparator = t, this.data = new On(this.comparator);
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Kn = new On(Pt.comparator);

function jn() {
    return Kn;
}

var zn = new On(Pt.comparator);
...
var Hn = new On(Pt.comparator), Yn = new Un(Pt.comparator);
 ...
 */ var Zn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, tr.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(dt.min(), r, Xn(), jn(), Jn());
    }, t;
}(), tr = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Tt.EMPTY_BYTE_STRING, n, Jn(), Jn(), Jn());
    }, t;
}(), er = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype._t = function(t) {
        ...
        if (r) {
            ...
            if (ge(i)) if (0 === n) {
                ...
                // queries.
                var o = new Pt(i.path);
                this.ct(e, o, ie.newNoDocument(o, dt.min()));
    ...
    t.prototype.yt = function(t) {
        ...
        this.st.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && ge(o.target)) {
                    ...
                    null !== e.it.get(s) || e.It(i, s) || e.ct(i, s, ie.newNoDocument(s, t));
                }
                r.j && (n.set(i, r.H()), r.J());
            }
        }));
        ...
        var i = new Zn(t, n, this.ot, this.it, r);
        return this.it = jn(), this.rt = sr(), this.ot = new Un(ct), i;
    }, 
    /**
    ...
    t.prototype.Z = function(t) {
        ...
        var e = this.st.get(t);
        return e || (e = new ir, this.st.set(t, e)), e;
    }, t.prototype.Tt = function(t) {
        var e = this.rt.get(t);
        return e || (e = new Un(ct), this.rt = this.rt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.dt = function(t) {
        var e = this;
        this.st.set(t, new ir), this.nt.getRemoteKeysForTarget(t).forEach((function(n) {
...
function br(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? gt.emptyPath() : Er(e);
}
...
function Sr(t, e, n) {
    var r = gr(t, e.name), i = pr(e.updateTime), o = new ne({
        mapValue: {
            fields: e.fields
        }
    }), s = ie.newFoundDocument(r, i, o);
...
function Nr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? vn.updateTime(pr(t.updateTime)) : void 0 !== t.exists ? vn.exists(t.exists) : vn.none();
    }(e.currentDocument) : vn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new sn; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new un(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new cn(i);
            } else "increment" in e ? n = new hn(t, e.increment) : j();
    ...
    if (e.update) {
        e.update.name;
        var i = gr(t, e.update.name), o = new ne({
            mapValue: {
...
function Ar(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = wr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = wr(t, r.popLast()), n.structuredQuery.from = [ {
...
function Cr(t) {
    var e = br(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = xr(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new xe(Rr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    return n.endAt && (l = function(t) {
        var e = !t.before, n = t.values || [];
        return new Ce(n, e);
    }(n.endAt)), Le(e, i, u, s, a, "F" /* First */ , c, l);
}

function xr(t) {
    return t ? void 0 !== t.unaryFilter ? [ Pr(t) ] : void 0 !== t.fieldFilter ? [ Lr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return xr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : j() : [];
...
function Lr(t) {
    return be.create(Rr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ function qr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Br(e)), e = Ur(t.get(n), e);
    return Br(e);
}
 ...
 * information.
 */ var Qr = {}, Wr = [ "prefixPath", "collectionGroup", "readTime", "documentId" ], Hr = [ "prefixPath", "collectionGroup", "documentId" ], Yr = [ "collectionGroup", "readTime", "prefixPath", "documentId" ], Jr = [ "canonicalId", "targetId" ], $r = [ "targetId", "path" ], Xr = [ "path", "targetId" ], Zr = [ "collectionId", "parent" ], ti = [ "indexId", "uid" ], ei = [ "uid", "sequenceNumber" ], ni = [ "indexId", "uid", "arrayValue", "directionalValue", "documentKey" ], ri = [ "indexId", "uid", "documentKey" ], ii = [ "userId", "collectionPath", "documentId" ], oi = [ "userId", "collectionPath", "largestBatchId" ], si = [ "userId", "collectionGroup", "largestBatchId" ], ui = e(e([], e(e([], e(e([], e(e([], [ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ]), [ "clientMetadata" ])), [ "remoteDocumentGlobal" ])), [ "collectionParents" ])), [ "bundles", "namedQueries" ]), ai = e(e([], ui), [ "documentOverlays" ]), ci = [ "mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays" ], li = e(e([], ci), [ "indexConfiguration", "indexState", "indexEntries" ]), hi = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", fi = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.At = new J, this.transaction.oncomplete = function() {
            n.At.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.At.reject(new mi(t, e.error)) : n.At.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Ei(e.target.error);
            n.At.reject(new mi(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), bi(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = r.sent(), e = pi.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).next((function(t) {
                                    return e.bt(), t;
                                })).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), di.reject(t);
                                })).toPromise(), c = {}, u.catch((function() {})), [ 4 /*yield*/ , e.Rt ];
                              ...
                              case 4:
                                return l = r.sent(), h = "FirebaseError" !== l.name && s < 3, U("SimpleDb", "Transaction failed with error:", l.message, "Retrying:", h), 
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function gi(t) {
 ...
 */ var wi = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), bi(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return bi(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), bi(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), bi(this.store.count());
    ...
    t.prototype.Kt = function(t, e) {
        ...
        n.jt = !1;
        var r = this.cursor(n);
        return this.Gt(r, (function(t, e, n) {
            return n.delete();
        }));
    ...
    t.prototype.zt = function(t) {
        ...
        var n = [];
        return new di((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new vi(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof di) {
                        var u = s.catch((function(t) {
                            return o.done(), di.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 */ var _i = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && wn(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && bn(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && bn(s, t, this.localWriteTime);
        }
    }, 
    /**
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = dt.min()), void 0 === o && (o = dt.min()), void 0 === s && (s = Tt.EMPTY_BYTE_STRING), 
...
/** Encodes a document for storage locally. */ function xi(t, e) {
    var n = e.key, r = {
    ...
    if (e.isFoundDocument()) r.document = function(t, e) {
        return {
            ...
            updateTime: hr(t, e.version.toTimestamp())
        };
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Ri(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return Nr(t.Jt, e);
    })), u = ft.fromMillis(e.localWriteTimeMs);
    return new _i(e.batchId, u, n, s);
}
...
/** Decodes a DbTarget into TargetData */ function Li(t) {
    ...
    e = Ke(Pe(br(n.documents[0])))) : e = function(t) {
        return Ke(Cr(t));
    }(t.query), new Ai(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Tt.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Pi(t, e) {
    var n, r = Mi(e.snapshotVersion), i = Mi(e.lastLimboFreeSnapshotVersion);
    n = ge(e.target) ? Dr(t.Jt, e.target) : Ar(t.Jt, e.target);
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function Fi(t, e) {
    return new Di(e.largestBatchId, Nr(t.Jt, e.overlayMutation));
}
 ...
 */ var Ki = /** @class */ function() {
    ...
    return t.Yt = function(e, n) {
        ...
        e.forEach((function(t) {
            return i.add(qr(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(ji(t).Qt("collectionPathOverlayIndex", i));
        })), di.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = Wn(), o = qr(e), s = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return ji(t).qt("collectionPathOverlayIndex", s).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], s = Fi(r.M, o);
                i.set(s.getKey(), s);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, s = Wn(), u = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return ji(t).Wt({
            ...
            var u = Fi(o.M, e);
            s.size() < r || u.largestBatchId === i ? (s.set(u.getKey(), u), i = u.largestBatchId) : n.done();
        })).next((function() {
            return s;
        }));
    }, t.prototype.Xt = function(t, e) {
        return ji(t).put(function(t, e, n) {
            var r = qi(e, n.mutation.key);
            return r[0], {
                userId: e,
                collectionPath: r[1],
                documentId: r[2],
                ...
                overlayMutation: _r(t.Jt, n.mutation)
            };
...
/** Firestore index value writer.  */ var zi = /** @class */ function() {
    function t() {}
...
var Hi = /** @class */ function() {
    ...
    function t() {
        this.De = new Hi, this.Ce = new Yi(this.De), this.xe = new Ji(this.De);
    }
...
function Zi(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = to(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = to(t.directionalValue, e.directionalValue)) ? n : Pt.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var eo = /** @class */ function() {
     ...
     */    return t.prototype.$e = function(t) {
        ...
        for (var n = ue(t), r = 0, i = 0; r < n.length && this.Be(n[r]); ++r) ;
        ...
        // orderBy.
                for (;r < n.length; ++r) {
            var s = n[r];
            if (i >= this.Me.length || !this.Ue(this.Me[i++], s)) return !1;
        }
        return !0;
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.qe.add(e), di.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return di.resolve(this.qe.getEntries(e));
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Un(gt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Un(gt.comparator)).toArray();
    }, t;
}(), io = new Uint8Array(0), oo = /** @class */ function() {
    function t(t) {
        this.user = t, 
        /**
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return so(t).qt(r).next((function(t) {
        ...
        var n = this, r = uo(t), i = !0, o = new Map;
        return di.forEach(this.Qe(e), (function(e) {
            ...
            if (i) {
                var t = Jn();
                return di.forEach(o, (function(i, o) {
                    var s;
                    ...
                    })).join(",") + " to execute ") + ve(e));
                    var u = function(t, e) {
                        var n = se(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = we(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = ue(e); r < i.length; r++) for (var o = i[r], s = 0, u = we(t, o.fieldPath); s < u.length; s++) {
                            var a = u[s];
                            switch (a.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                        ...
                        // startAt.
                        for (var n, r = [], i = !0, o = 0, s = ue(e); o < s.length; o++) {
                            // Process all filters to find a value for the current field segment
                            for (var u = s[o], a = void 0, c = !0, l = 0, h = we(t, u.fieldPath); l < h.length; l++) {
                                var f = h[l], d = void 0, p = !0;
                                switch (f.op) {
                                  case "<" /* LESS_THAN */ :
                                  case "<=" /* LESS_THAN_OR_EQUAL */ :
                                    d = "nullValue" in (n = f.value) ? Ft : "booleanValue" in n ? {
                                        booleanValue: !1
                                        ...
                                        bytesValue: ""
                                    } : "referenceValue" in n ? Qt(Mt.empty(), Pt.empty()) : "geoPointValue" in n ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
                            ...
                            // boundary to see if we can narrow the scope.
                                                        if (null !== t.startAt) for (var y = 0; y < t.orderBy.length; ++y) if (t.orderBy[y].field.isEqual(u.fieldPath)) {
                                var v = t.startAt.position[y];
                                te(a, v) === v && (a = v, c = t.startAt.inclusive);
                                break;
                            }
                            if (void 0 === a) 
                        ...
                        /** Returns the largest value for the given value type (exclusive). */ return new Ce(r, i);
                    }(o, i), l = function(t, e) {
                        ...
                        for (var n, r = [], i = !0, o = 0, s = ue(e); o < s.length; o++) {
                                ...
                                switch (f.op) {
                                  ...
                                  case ">" /* GREATER_THAN */ :
                                    d = "nullValue" in (n = f.value) ? {
                                        ...
                                        bytesValue: ""
                                    } : "bytesValue" in n ? Qt(Mt.empty(), Pt.empty()) : "referenceValue" in n ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
                            ...
                            // boundary to see if we can narrow the scope.
                                                        if (null !== t.endAt) for (var y = 0; y < t.orderBy.length; ++y) if (t.orderBy[y].field.isEqual(u.fieldPath)) {
                                var v = t.endAt.position[y];
                                ee(a, v) === v && (a = v, c = t.endAt.inclusive);
                                break;
                            }
                            if (void 0 === a) 
                        ...
                        return new Ce(r, i);
                    }(o, i), h = n.je(i, o, c), f = n.je(i, o, l), d = n.We(i, o, a), p = n.ze(i.indexId, u, h, !!c && c.inclusive, f, !!l && l.inclusive, d);
                    return di.forEach(p, (function(n) {
                        return r.Kt(n, e.limit).next((function(e) {
                            e.forEach((function(e) {
                                t = t.add(new Pt(Gr(e.documentKey)));
                            }));
                        }));
                    }));
                })).next((function() {
     ...
     * bounds.
     */
    t.prototype.ze = function(t, e, n, r, i, o, s) {
        for (var u = this, a = (null != e ? e.length : 1) * Math.max(null != n ? n.length : 1, null != i ? i.length : 1), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.He(e[a / c]) : io, d = n ? f.Je(t, h, n[a % c], r) : f.Ye(t), p = i ? f.Xe(t, h, i[a % c], o) : f.Ye(t + 1);
            l.push.apply(l, f.createRange(d, p, s.map((function(e) {
                return u.Je(t, h, e, 
                /* inclusive= */ !0);
            }))));
        }, f = this, d = 0
    ...
    t.prototype.Ye = function(t) {
        return new Xi(t, Pt.empty(), io, io);
    }, t.prototype.getFieldIndex = function(t, e) {
        var n = new eo(e), r = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    t.prototype.Ze = function(t, e) {
        for (var n = new $i, r = 0, i = ue(t); r < i.length; r++) {
            var o = i[r], s = e.data.field(o.fieldPath);
    ...
    t.prototype.We = function(t, e, n) {
        ...
        var r = [];
        r.push(new $i);
        for (var i = 0, o = 0, s = ue(t); o < s.length; o++) for (var u = s[o], a = n[i++], c = 0, l = r; c < l.length; c++) {
            var h = l[c];
            if (this.tn(e, u.fieldPath) && Ht(a)) r = this.en(r, u, a); else {
                var f = h.Ne(u.kind);
                zi.fe.Zt(a, f);
            }
        }
    ...
    /** Returns the byte representation for the provided encoders. */ t.prototype.nn = function(t) {
     ...
     */
    t.prototype.en = function(t, n, r) {
        for (var i = e([], t), o = [], s = 0, u = r.arrayValue.values || []; s < u.length; s++) for (var a = u[s], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new $i;
            f.seed(h.Se()), zi.fe.Zt(a, f.Ne(n.kind)), o.push(f);
        }
        return o;
    }, t.prototype.tn = function(t, e) {
        return !!t.filters.find((function(t) {
            return t instanceof be && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op);
        }));
    }, t.prototype.getFieldIndexes = function(t, e) {
        var n = this, r = ao(t), i = co(t);
        return (e ? r.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.qt()).next((function(t) {
            var e = [];
            return di.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new ce(e.sequenceNumber, new fe(Vi(e.readTime), new Pt(Gr(e.documentKey)), e.largestBatchId)) : ce.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
                            return new ae(bt.fromServerFormat(e), n);
                        }));
                        return new oe(t.indexId, t.collectionGroup, r, n);
                    }(t, n));
                }));
            })).next((function() {
                return e;
        ...
        var r = this, i = ao(t), o = co(t);
        return this.sn(t).next((function(t) {
            return i.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((function(e) {
                return di.forEach(e, (function(e) {
                    return o.put(function(t, e, n, r) {
                        return {
                            indexId: t,
                            uid: e.uid || "",
                            sequenceNumber: n,
                            readTime: Mi(r.readTime),
                            documentKey: qr(r.documentKey.path),
        ...
        // here.
                return di.forEach(e, (function(e, i) {
            var o = r.get(e.collectionGroup);
            return (o ? di.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), di.forEach(o, (function(r) {
                    return n.rn(t, e, r).next((function(e) {
                        var o = n.on(i, r);
                        return e.isEqual(o) ? di.resolve() : n.un(t, i, e, o);
                    }));
                }));
            }));
        }));
        ...
        return uo(t).put({
            ...
            documentKey: qr(e.key.path)
        });
    }, t.prototype.cn = function(t, e, n) {
        return uo(t).delete([ n.indexId, this.uid, n.arrayValue, n.directionalValue, qr(e.key.path) ]);
    }, t.prototype.rn = function(t, e, n) {
        var r = uo(t), i = new Un(Zi);
        return r.Wt({
            index: "documentKeyIndex",
            range: IDBKeyRange.only([ n.indexId, this.uid, qr(e.path) ])
        }, (function(t, r) {
            i = i.add(new Xi(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.on = function(t, e) {
        var n = new Un(Zi), r = this.Ze(e, t);
        if (null == r) return n;
        var i = se(e);
        if (null != i) {
            var o = t.data.field(i.fieldPath);
            if (Ht(o)) for (var s = 0, u = o.arrayValue.values || []; s < u.length; s++) {
                var a = u[s];
                n = n.add(new Xi(e.indexId, t.key, this.He(a), r));
            }
        } else n = n.add(new Xi(e.indexId, t.key, io, r));
        return n;
    }, 
    /**
     ...
     * entries.
     */
    t.prototype.un = function(t, e, n, r) {
        var i = this;
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), s = e.getIterator(), u = Gn(o), a = Gn(s); u || a; ) {
                var c = !1, l = !1;
                if (u && a) {
                    var h = n(u, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = Gn(s)) : l ? (i(u), u = Gn(o)) : (u = Gn(o), a = Gn(s));
            }
        }(n, r, Zi, (
        /* onAdd= */ function(n) {
            o.push(i.an(t, e, n));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        n = n.sort((function(t, e) {
            ...
            return !e || 0 !== Zi(t, n[e - 1]);
        }));
        var r = [];
        r.push(t);
        for (var i = 0, o = n; i < o.length; i++) {
            var s = o[i], u = Zi(s, t), a = Zi(s, e);
            if (0 === u) 
            // `notInValue` is the lower bound. We therefore need to raise the bound
            // to the next value.
            r[0] = t.ke(); else if (u > 0 && a < 0) 
            // `notInValue` is in the middle of the range
            r.push(s), r.push(s.ke()); else if (a > 0) 
 ...
 */
function fo(t, e, n) {
    var r = t.store("mutations"), i = t.store("documentMutations"), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Wt({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], l = 0, h = n.mutations; l < h.length; l++) {
        var f = h[l], d = zr(e, f.key.path, n.batchId);
        o.push(i.delete(d)), c.push(f.key);
    }
    return di.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ ho.DEFAULT_COLLECTION_PERCENTILE = 10, 
ho.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, ho.DEFAULT = new ho(41943040, ho.DEFAULT_COLLECTION_PERCENTILE, ho.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
ho.DISABLED = new ho(-1, 0, 0);
...
var yo = /** @class */ function() {
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            z("number" == typeof u);
            for (var a = new _i(u, e, n, r), c = function(t, e, n) {
            ...
            }(i.M, i.userId, a), l = [], h = new Un((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], y = zr(i.userId, p.key.path, u);
                h = h.add(p.key.path.popLast()), l.push(s.put(c)), l.push(o.put(y, Qr));
            }
            return h.forEach((function(e) {
                l.push(i.indexManager.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.hn[u] = a.keys();
            })), di.waitFor(l).next((function() {
                return a;
            }));
        }));
        ...
        return mo(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), Ri(n.M, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.ln = function(t, e) {
        var n = this;
        return this.hn[e] ? di.resolve(this.hn[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.hn[e] = r, r;
            }
        ...
        return mo(t).Wt({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = Ri(n.M, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return mo(t).qt("userMutationsIndex", n).next((function(t) {
            return t.map((function(t) {
                return Ri(e.M, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = jr(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return go(t).Wt({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], c = r[2], l = Gr(a);
            ...
            return mo(t).get(c).next((function(t) {
                if (!t) throw j();
                z(t.userId === n.userId), o.push(Ri(n.M, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Un(ct), i = [];
        return e.forEach((function(e) {
            var o = jr(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = go(t).Wt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = Gr(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), di.waitFor(i).next((function() {
            return n.fn(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = jr(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Un(ct);
        return go(t).Wt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], l = Gr(a);
        ...
        return e.forEach((function(e) {
            i.push(mo(t).get(e).next((function(t) {
                if (null === t) throw j();
                z(t.userId === n.userId), r.push(Ri(n.M, t));
            })));
        })), di.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return fo(t.Ht, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.dn(e.batchId);
            })), di.forEach(r, (function(e) {
    ...
    t.prototype._n = function(t) {
        var e = this;
        return wo(t).get(this.userId).next((function(t) {
            return t || {
                userId: e.userId,
 ...
 */ function vo(t, e, n) {
    var r = jr(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return go(t).Wt({
        range: o,
        jt: !0
    }, (function(t, n, r) {
 ...
 */ var bo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        var e = this;
        return this.yn(t).next((function(n) {
            var r = new bo(n.highestTargetId);
        ...
        var r = this;
        return this.yn(t).next((function(i) {
        ...
        var n = this;
        return this.In(t, e).next((function() {
            return n.yn(t).next((function(r) {
                return r.targetCount += 1, n.Tn(e, r), n.pn(t, r);
            }));
        }));
    ...
    t.prototype.Tn = function(t, e) {
        ...
        var n = ve(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Eo(t).Wt({
            range: r,
        ...
        // IndexedDb.
                return di.forEach(e, (function(e) {
            var o = qr(e.path);
            return di.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = So(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = So(t), i = Jn();
        return r.Wt({
            range: n,
            jt: !0
        }, (function(t, e, n) {
            var r = Gr(t[1]), o = new Pt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = qr(e.path), r = IDBKeyRange.bound([ n ], [ ht(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return So(t).Wt({
 ...
 */ function _o(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== hi) throw t;
 ...
 */ var Do = /** @class */ function() {
    function t(t) {
        this.En = t, this.buffer = new Un(No), this.An = 0;
    }
    return t.prototype.Rn = function() {
        ...
        if (this.buffer.size < this.En) this.buffer = this.buffer.add(e); else {
            ...
            No(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
        ...
        U("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.Vn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.Vn = null, this.Pn = !0, n.label = 1;
                      ...
                      case 3:
                        return gi(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        return this.Sn.Dn(t).next((function(t) {
            return Math.floor(e / 100 * t);
        }));
    }, t.prototype.nthSequenceNumber = function(t, e) {
        var n = this;
        if (0 === e) return di.resolve(st.A);
        var r = new Do(e);
        return this.Sn.forEachTarget(t, (function(t) {
            return r.bn(t.sequenceNumber);
        })).next((function() {
            return n.Sn.Cn(t, (function(t) {
                return r.bn(t);
            }));
        })).next((function() {
            return r.maxValue;
        ...
        di.resolve(lo)) : this.getCacheSize(t).next((function(r) {
        ...
        var n, r, i, o, s, u, a, c = this, l = Date.now();
    ...
    t.prototype.Mn = function(t, e) {
        return function(t, e) {
            var n = !1;
            return wo(t).zt((function(r) {
                return vo(t, r, e).next((function(t) {
                    return t && (n = !0), di.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
        ...
        return this.kn(t, (function(s, u) {
            if (u <= e) {
                var a = n.Mn(t, s).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s, dt.min()), So(t).delete([ 0, qr(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Mo = /** @class */ function() {
    function t() {
        ...
        this.changes = new Pn((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? di.resolve(n) : this.getFromCache(t, e);
    }, 
    /**
 ...
 */
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        return this.getMetadata(t).next((function(r) {
            return r.byteSize += e, n.On(t, r);
        }));
    }, t.prototype.getEntry = function(t, e) {
        var n = this, r = ie.newInvalidDocument(e);
        return Po(t).Wt({
            index: "documentKeyIndex",
            range: IDBKeyRange.only(Oo(e))
        }, (function(t, i) {
            r = n.Fn(e, i);
        })).next((function() {
            return r;
    ...
    t.prototype.$n = function(t, e) {
        ...
        var n = this, r = jn();
        return this.Bn(t, e, (function(t, e) {
            var i = n.Fn(t, e);
            r = r.insert(t, i);
        })).next((function() {
            return r;
     ...
     */
    t.prototype.Ln = function(t, e) {
        var n = this, r = jn(), i = new On(Pt.comparator);
        return this.Bn(t, e, (function(t, e) {
            var o = n.Fn(t, e);
            r = r.insert(t, o), i = i.insert(t, po(e));
        })).next((function() {
            return {
                documents: r,
                Un: i
    ...
    }, t.prototype.Bn = function(t, n, r) {
        if (n.isEmpty()) return di.resolve();
        var i = new Un(qo);
        n.forEach((function(t) {
            return i = i.add(t);
        }));
        var o = IDBKeyRange.bound(Oo(i.first()), Oo(i.last())), s = i.getIterator(), u = s.getNext();
        return Po(t).Wt({
            index: "documentKeyIndex",
            range: o
        }, (function(t, n, i) {
            // Go through keys not found in cache.
            for (var o = Pt.fromSegments(e(e([], n.prefixPath), [ n.collectionGroup, n.documentId ])); u && qo(u, o) < 0; ) r(u, null), 
            u = s.getNext();
            u && u.isEqual(o) && (
            // Key found in cache.
            r(u, n), u = s.hasNext() ? s.getNext() : null), 
            // Skip to the next key (if there is one).
            u ? i.Ut(Oo(u)) : i.done();
        })).next((function() {
            // The rest of the keys are not in the cache. One case where `iterate`
            // above won't go through them is when the cache is empty.
            for (;u; ) r(u, null), u = s.hasNext() ? s.getNext() : null;
        }));
        ...
        return Po(t).qt(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = jn(), n = 0, i = t; n < i.length; n++) {
                var o = i[n], s = r.Fn(Pt.fromSegments(o.prefixPath.concat(o.collectionGroup, o.documentId)), o);
                e = e.insert(s.key, s);
            }
            return e;
        }));
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        var i = this, o = jn(), s = Fo(e, n), u = Fo(e, fe.max());
        return Po(t).Wt({
            index: "collectionGroupIndex",
            range: IDBKeyRange.bound(s, u, !0)
        }, (function(t, e, n) {
            var s = i.Fn(Pt.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
            (o = o.insert(s.key, s)).size === r && n.done();
        })).next((function() {
            return o;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Ro(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Lo(t).get("remoteDocumentGlobalKey").next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.On = function(t, e) {
        return Lo(t).put("remoteDocumentGlobalKey", e);
    }, 
    /**
    ...
    t.prototype.Fn = function(t, e) {
        if (e) {
            ...
            /** Decodes a remote document from storage locally to a Document. */ function(t, e) {
                var n;
                if (e.document) n = Sr(t.Jt, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
                    var r = Pt.fromSegments(e.noDocument.path), i = Vi(e.noDocument.readTime);
                    n = ie.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
                } else {
                    if (!e.unknownDocument) return j();
                    var o = Pt.fromSegments(e.unknownDocument.path), s = Vi(e.unknownDocument.version);
                    n = ie.newUnknownDocument(o, s);
                }
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).qn = t, r.trackRemovals = n, 
        // A map of document sizes and read times prior to applying the changes in
        // this buffer.
        r.Gn = new Pn((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new Un((function(t, e) {
            return ct(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var u = e.Gn.get(o);
            if (n.push(e.qn.removeEntry(t, o, u.readTime)), s.isValidDocument()) {
                var a = xi(e.qn.M, s);
                i = i.add(o.path.popLast());
                var c = po(a);
                r += c - u.size, n.push(e.qn.addEntry(t, o, a));
            } else if (r -= u.size, e.trackRemovals) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var l = xi(e.qn.M, s.convertToNoDocument(dt.min()));
                n.push(e.qn.addEntry(t, o, l));
            }
        })), i.forEach((function(r) {
            n.push(e.qn.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.qn.updateMetadata(t, r)), di.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.qn.$n(t, e).next((function(t) {
            return n.Gn.set(e, {
                size: t.size,
        ...
        // a delta later.
            ...
            return t.Un.forEach((function(t, r) {
                n.Gn.set(t, {
                    size: r,
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Uo = /** @class */ function() {
    function t(t) {
        this.M = t;
    }
    /**
     ...
     */    return t.prototype.kt = function(t, e, n, r) {
        var i = this, o = new pi("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore("mutationQueues", {
                ...
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", Kr, {
                unique: !0
     ...
     */
        ...
        s = s.next((function() {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", oi, {
                    unique: !1
            ...
            return function(t) {
                ...
                e.createIndex("documentKeyIndex", Hr), e.createIndex("collectionGroupIndex", Yr);
            }(t);
        })).next((function() {
            return i.Hn(t, o);
        })).next((function() {
            ...
            !function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: ti
                }).createIndex("sequenceNumberIndex", ei, {
                    unique: !1
        ...
        return n.qt().next((function(n) {
            return di.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.qt("userMutationsIndex", i).next((function(r) {
                    return di.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = Ri(e.M, r);
                        return fo(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.jn = function(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((function(t) {
            ...
            return n.Wt((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? di.resolve() : function(n) {
                        return e.put({
                            targetId: 0,
                            path: qr(n),
        ...
        var n = e.store("collectionParents"), r = new ro, i = function(t) {
            if (r.add(t)) {
        ...
        return n.Wt((function(t, r) {
            var i = Li(r), o = Pi(e.M, i);
            return n.put(o);
        }));
    }, t.prototype.Hn = function(t, e) {
        var n = e.store("remoteDocuments"), r = [];
        return n.Wt((function(t, n) {
            var i, o = e.store("remoteDocumentsV14"), s = (i = n, i.document ? new Pt(gt.fromString(i.document.name).popFirst(5)) : i.noDocument ? Pt.fromSegments(i.noDocument.path) : i.unknownDocument ? Pt.fromSegments(i.unknownDocument.path) : j()).path.toArray(), u = {
...
function Bo(t) {
    t.createObjectStore("targetDocuments", {
        keyPath: $r
    }).createIndex("documentTargetsIndex", Xr, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore("targets", {
        keyPath: "targetId"
    }).createIndex("queryTargetsIndex", Jr, {
        unique: !0
    }), t.createObjectStore("targetGlobal");
}

var Go = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ko = /** @class */ function() {
    function t(
    /**
    ...
    l, h) {
        ...
        this.clientId = r, this.Jn = o, this.window = s, this.document = u, this.Yn = c, 
        this.Xn = l, this.Zn = h, this.ts = null, this.es = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        this.referenceDelegate = new xo(this, i), this.cs = n + "main", this.M = new Ci(a), 
        this.hs = new yi(this.cs, this.Zn, new Uo(this.M)), this.ls = new Io(this.referenceDelegate, this.M), 
        this.fs = function(t) {
            return new Vo(t);
        }(this.M), this.ds = new Ui, this.window && this.window.localStorage ? this._s = this.window.localStorage : (this._s = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new Y(H.FAILED_PRECONDITION, Go);
            return t.gs(), t.ys(), t.ps(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.ls.getHighestSequenceNumber(e);
            }));
        })).then((function(e) {
            t.ts = new st(e, t.Yn);
        })).then((function() {
            ...
            return t.hs && t.hs.close(), Promise.reject(e);
        }));
    }, 
    /**
    ...
    t.prototype.setNetworkEnabled = function(t) {
        ...
        this.Jn.enqueueAndForget((function() {
            return n(e, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.started ? [ 4 /*yield*/ , this.ws() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.ws = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return zo(e).put({
                ...
                if (t.isPrimary) return t.Ts(e).next((function(e) {
                    e || (t.isPrimary = !1, t.Jn.enqueueRetryable((function() {
                        return t.us(!1);
                    })));
                }));
            })).next((function() {
                ...
                return t.isPrimary && !n ? t.As(e).next((function() {
                    return !1;
                })) : !!n && t.Rs(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
            ...
            t.isPrimary !== e && t.Jn.enqueueRetryable((function() {
                return t.us(e);
            })), t.isPrimary = e;
        }));
    }, t.prototype.Ts = function(t) {
        var e = this;
        return jo(t).get("owner").next((function(t) {
            return di.resolve(e.bs(t));
        }));
    }, t.prototype.Ps = function(t) {
        return zo(t).delete(this.clientId);
    }, 
    /**
    ...
    t.prototype.Vs = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return !this.isPrimary || this.vs(this.os, 18e5) ? [ 3 /*break*/ , 2 ] : (this.os = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.qt().next((function(t) {
                            var n = o.Ss(t, 18e5), r = t.filter((function(t) {
                                return -1 === n.indexOf(t);
                            }));
                            // Delete metadata for clients that are no longer considered active.
                                                        return di.forEach(r, (function(t) {
                  ...
                  case 1:
                    ...
                    if (t = r.sent(), this._s) for (e = 0, n = t; e < n.length; e++) i = n[e], this._s.removeItem(this.Ds(i.clientId));
                    r.label = 2;
    ...
    t.prototype.ps = function() {
        var t = this;
        this.rs = this.Jn.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t.ws().then((function() {
                return t.Vs();
            })).then((function() {
                return t.ps();
            }));
    ...
    t.prototype.Es = function(t) {
        var e = this;
        return this.Xn ? di.resolve(!0) : jo(t).get("owner").next((function(n) {
            ...
            if (null !== n && e.vs(n.leaseTimestampMs, 5e3) && !e.Cs(n.ownerId)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || zo(t).qt().next((function(t) {
                return void 0 === e.Ss(t, 5e3).find((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.es = !1, this.xs(), this.rs && (this.rs.cancel(), this.rs = null), this.Ns(), 
                    this.ks(), [ 4 /*yield*/ , this.hs.runTransaction("shutdown", "readwrite", [ "owner", "clientMetadata" ], (function(e) {
                        var n = new Ti(e, st.A);
    ...
    t.prototype.Ss = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.vs(t.updateTimeMs, e) && !n.Cs(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.Os = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return zo(e).qt().next((function(e) {
                return t.Ss(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return yo.Yt(t, this.M, e, this.referenceDelegate);
        ...
        return Ki.Yt(this.M, t);
    }, t.prototype.getBundleCache = function() {
        return this.ds;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        U("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, s = "readonly" === e ? "readonly" : "readwrite", u = 14 === (i = this.Zn) ? li : 13 === i ? ci : 12 === i ? ai : 11 === i ? ui : void j();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.hs.runTransaction(t, s, u, (function(i) {
            return o = new Ti(i, r.ts ? r.ts.next() : st.A), "readwrite-primary" === e ? r.Ts(o).next((function(t) {
                return !!t || r.Es(o);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Jn.enqueueRetryable((function() {
                    return r.us(!1);
                })), new Y(H.FAILED_PRECONDITION, hi);
                return n(o);
            })).next((function(t) {
                return r.Rs(o).next((function() {
                    return t;
                }));
            })) : r.Fs(o).next((function() {
                return n(o);
            }));
        })).then((function(t) {
    ...
    t.prototype.Fs = function(t) {
        var e = this;
        return jo(t).get("owner").next((function(t) {
            if (null !== t && e.vs(t.leaseTimestampMs, 5e3) && !e.Cs(t.ownerId) && !e.bs(t) && !(e.Xn || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, Go);
        }));
    }, 
    /**
    ...
    t.prototype.Rs = function(t) {
        ...
        return jo(t).put("owner", e);
    }, t.vt = function() {
        return yi.vt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.As = function(t) {
        var e = this, n = jo(t);
        return n.get("owner").next((function(t) {
            return e.bs(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete("owner")) : di.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.vs = function(t, e) {
        var n = Date.now();
        ...
        null !== this.document && "function" == typeof this.document.addEventListener && (this.ss = function() {
            t.Jn.enqueueAndForget((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.ws();
            }));
    ...
    t.prototype.ys = function() {
        var t, e = this;
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ns = function() {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            e.xs(), p() && navigator.appVersion.match(/Version\/1[45]/) && 
            // On Safari 14 and 15, we do not run any cleanup actions as it might
            // trigger a bug that prevents Safari from re-opening IndexedDB during
            // the next page load.
            // See https://bugs.webkit.org/show_bug.cgi?id=226547
            e.Jn.enterRestrictedMode(/* purgeExistingTasks= */ !0), e.Jn.enqueueAndForget((function() {
                return e.shutdown();
            }));
    ...
    t.prototype.Cs = function(t) {
        var e;
        try {
            var n = null !== (null === (e = this._s) || void 0 === e ? void 0 : e.getItem(this.Ds(t)));
    ...
    /** Removes the zombied client entry if it exists. */ t.prototype.Ms = function() {
        if (this._s) try {
...
var Wo = /** @class */ function() {
    ...
    return t.prototype.Bs = function(t, e) {
        var n = this;
        return this.$s.getAllMutationBatchesAffectingDocumentKey(t, e).next((function(r) {
            return n.Ls(t, e, r);
        }));
    }, 
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.Ls = function(t, e, n) {
        return this.fs.getEntry(t, e).next((function(t) {
    ...
    t.prototype.qs = function(t, e) {
        var n = this;
        return this.fs.getEntries(t, e).next((function(e) {
    ...
    t.prototype.Gs = function(t, e) {
        var n = this;
        return this.$s.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            return n.Us(e, t);
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return Pt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Qs(t, e.path) : Be(e) ? this.js(t, e, n) : this.Ws(t, e, n);
    }, t.prototype.Qs = function(t, e) {
        // Just do a simple document lookup.
        return this.Bs(t, new Pt(e)).next((function(t) {
            var e = Qn();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.js = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = Qn();
        return this.indexManager.getCollectionParents(t, i).next((function(s) {
            return di.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new Re(e, 
        ...
        // Query the remote documents and overlay mutations.
                return this.fs.getAllFromCollection(t, e.path, n).next((function(n) {
            return r = n, i.$s.getAllMutationBatchesAffectingQuery(t, e);
        })).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) for (var i = n[e], o = 0, s = i.mutations; o < s.length; o++) {
                var u = s[o], a = u.key, c = r.get(a);
                null == c && (
                // Create invalid document to apply mutations on top of
                c = ie.newInvalidDocument(a), r = r.insert(a, c)), bn(u, c, i.localWriteTime), c.isFoundDocument() || (r = r.remove(a));
            }
        })).next((function() {
    ...
    function t(t, e, n, r) {
        this.targetId = t, this.fromCache = e, this.zs = n, this.Hs = r;
    }
    return t.Js = function(e, n) {
        for (var r = Jn(), i = Jn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    function t() {}
    /** Sets the document view to query against. */    return t.prototype.Ys = function(t) {
        this.Xs = t;
    }, 
    /** Returns all local documents matching the specified query. */ t.prototype.Ks = function(t, e, n, r) {
        var i = this;
        ...
        }(e) || n.isEqual(dt.min()) ? this.Zs(t, e) : this.Xs.qs(t, r).next((function(o) {
            var s = i.ti(e, o);
            return (Oe(e) || Fe(e)) && i.ei(e.limitType, s, r, n) ? i.Zs(t, e) : (F() <= h.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), We(e)), 
            i.Xs.Ks(t, e, le(n, -1)).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.ti = function(t, e) {
    ...
    t.prototype.ei = function(t, e, n, r) {
        ...
        return F() <= h.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", We(e)), 
        this.Xs.Ks(t, e, fe.min());
    }, t;
}(), Jo = /** @class */ function() {
    function t(
    /** Manages our in-memory or durable persistence. */
    t, e, n, r) {
        this.persistence = t, this.ni = e, this.M = r, 
        /**
    ...
    return t.prototype.ui = function(t) {
        ...
        this.ai = new Wo(this.oi, this.$s, this.indexManager), this.oi.setIndexManager(this.indexManager), 
        this.ni.Ys(this.ai);
    }, t.prototype.collectGarbage = function(t) {
        var e = this;
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (function(n) {
            return t.collect(n, e.si);
        }));
    }, t;
}();
            ...
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , (n = W(t)).persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    // before and after.
                    var r;
                    return n.$s.getAllMutationBatches(t).next((function(i) {
                        return r = i, n.ui(e), n.$s.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var i = [], o = [], s = Jn(), u = 0, a = r
                        ...
                        // of mutation batch IDs that were affected by change.
                                                return n.ai.qs(t, s).next((function(t) {
                            return {
                                ci: t,
                                removedBatchIds: i,
                                addedBatchIds: o
 ...
 */ function Zo(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        var r = e.batch.keys(), i = n.oi.newChangeBuffer({
            trackRemovals: !0
        });
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = di.resolve();
            return o.forEach((function(t) {
                ...
                return t.$s.removeMutationBatch(e, i);
            }));
        }(n, t, e, i).next((function() {
            return i.apply(t);
        })).next((function() {
            return n.$s.performConsistencyCheck(t);
        })).next((function() {
            return n.ai.qs(t, r);
        }));
    }));
 ...
 */ function ts(t) {
    ...
    return e.persistence.runTransaction("Get last remote snapshot version", "readonly", (function(t) {
        return e.ls.getLastRemoteSnapshotVersion(t);
    }));
}
 ...
 * queue.
 */ function es(t, e) {
    var n = W(t), r = e.snapshotVersion, i = n.si;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        var o = n.oi.newChangeBuffer({
            trackRemovals: !0
        });
        ...
        e.targetChanges.forEach((function(o, u) {
            ...
            if (a) {
                ...
                s.push(n.ls.removeMatchingKeys(t, o.removedDocuments, u).next((function() {
                    return n.ls.addMatchingKeys(t, o.addedDocuments, u);
                })));
                var c = a.withSequenceNumber(t.currentSequenceNumber);
                e.targetMismatches.has(u) ? c = c.withResumeToken(Tt.EMPTY_BYTE_STRING, dt.min()).withLastLimboFreeSnapshotVersion(dt.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(u, c), 
     ...
     */
                ...
                }(a, c, o) && s.push(n.ls.updateTargetData(t, c));
            }
        }));
        var u = jn();
        ...
        s.push(ns(t, o, e.documentUpdates).next((function(t) {
            u = t;
        }))), !r.isEqual(dt.min())) {
            var a = n.ls.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.ls.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(a);
        }
        return di.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.ai.Gs(t, u);
        })).next((function() {
...
function rs(t, e) {
    ...
    return n.persistence.runTransaction("Get next mutation batch", "readonly", (function(t) {
        return void 0 === e && (e = -1), n.$s.getNextMutationBatchAfterBatchId(t, e);
    }));
}
 ...
 */ function is(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        var r;
        return n.ls.getTargetData(t, e).next((function(i) {
            return i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            r = i, di.resolve(r)) : n.ls.allocateTargetId(t).next((function(i) {
                return r = new Ai(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.ls.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
        ...
        // the in-memory data
        var r = n.si.get(t.targetId);
        return (null === r || t.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.si = n.si.insert(t.targetId, t), 
...
function os(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), o = n.si.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 5:
                return n.si = n.si.remove(e), n.ii.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function ss(t, e, n) {
    var r = W(t), i = dt.min(), o = Jn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.ii.get(n);
            return void 0 !== i ? di.resolve(r.si.get(i)) : r.ls.getTargetData(e, n);
        }(r, t, Ke(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.ls.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.ni.Ks(t, e, n ? i : dt.min(), n ? o : Jn());
        })).next((function(t) {
            return cs(r, Ye(e), t), {
                documents: t,
                hi: o
...
// PORTING NOTE: Multi-Tab only.
function us(t, e) {
    var n = W(t), r = W(n.ls), i = n.si.get(e);
 ...
 */ function ls(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        var n, s, u, a, c, l, h, f, d, p;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = Jn(), u = jn(), a = 0, c = i; a < c.length; a++) l = c[a], h = e.li(l.metadata.name), 
                l.document && (s = s.add(h)), (f = e.fi(l)).setReadTime(e.di(l.metadata.readTime)), 
                u = u.insert(h, f);
                return d = n.oi.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , is(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return Ke(Pe(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return ns(t, d, u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
                        return n.ls.removeMatchingKeysForTargetId(t, p.targetId).next((function() {
                            return n.ls.addMatchingKeys(t, s, p.targetId);
                        })).next((function() {
                            return n.ai.Gs(t, e);
                        })).next((function() {
                            return e;
 ...
 */ function hs(t, e, i) {
    return void 0 === i && (i = Jn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , is(t, Ke(Oi(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.ds.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(Tt.EMPTY_BYTE_STRING, r);
                    return o.si = o.si.insert(s.targetId, s), o.ls.updateTargetData(t, s).next((function() {
                        return o.ls.removeMatchingKeysForTargetId(t, n.targetId);
                    })).next((function() {
                        return o.ls.addMatchingKeys(t, i, n.targetId);
                    })).next((function() {
                        return o.ds.saveNamedQuery(t, e);
                    }));
                })) ];
            }
        }));
 ...
 */ var fs = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return di.resolve(this._i.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return di.resolve(this.wi.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.overlays = new On(Pt.comparator), this.mi = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        return di.resolve(this.overlays.get(e));
    }, t.prototype.saveOverlays = function(t, e, n) {
        var r = this;
        return n.forEach((function(n, i) {
            r.Xt(t, e, i);
        ...
        var r = this, i = this.mi.get(n);
        return void 0 !== i && (i.forEach((function(t) {
            return r.overlays = r.overlays.remove(t);
        })), this.mi.delete(n)), di.resolve();
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        for (var r = Wn(), i = e.length + 1, o = new Pt(e.child("")), s = this.overlays.getIteratorFrom(o); s.hasNext(); ) {
            var u = s.getNext().value, a = u.getKey();
            if (!e.isPrefixOf(a.path)) break;
            // Documents from sub-collections
                        a.path.length === i && u.largestBatchId > n && r.set(u.getKey(), u);
        }
        return di.resolve(r);
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        for (var i = new On((function(t, e) {
            return t - e;
        })), o = this.overlays.getIterator(); o.hasNext(); ) {
            var s = o.getNext().value;
            if (s.getKey().getCollectionGroup() === e && s.largestBatchId > n) {
                var u = i.get(s.largestBatchId);
                null === u && (u = Wn(), i = i.insert(s.largestBatchId, u)), u.set(s.getKey(), s);
            }
        }
        for (var a = Wn(), c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return a.set(t, e);
        })), !(a.size() >= r)); ) ;
        return di.resolve(a);
        ...
        if (null !== n) {
            ...
            var o = this.mi.get(e);
            void 0 === o && (o = Jn(), this.mi.set(e, o)), this.mi.set(e, o.add(n.key));
        }
    }, t;
}(), ps = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.gi = new Un(ys.yi), 
        // A set of outstanding references to a document sorted by target id.
        this.pi = new Un(ys.Ii)
    ...
    /** Add references to the given document keys for the given ID. */ t.prototype.Ti = function(t, e) {
        var n = this;
    ...
    t.prototype.Ri = function(t) {
        var e = this, n = new Pt(new gt([])), r = new ys(n, t), i = new ys(n, t + 1), o = [];
        return this.pi.forEachInRange([ r, i ], (function(t) {
            e.Ei(t), o.push(t.key);
        })), o;
    }, t.prototype.bi = function() {
        var t = this;
        this.gi.forEach((function(e) {
            return t.Ei(e);
        }));
    }, t.prototype.Ei = function(t) {
        this.gi = this.gi.delete(t), this.pi = this.pi.delete(t);
    }, t.prototype.Pi = function(t) {
        var e = new Pt(new gt([])), n = new ys(e, t), r = new ys(e, t + 1), i = Jn();
        return this.pi.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new ys(t, 0), n = this.gi.firstAfterOrEqual(e);
    ...
    return t.yi = function(t, e) {
        return Pt.comparator(t.key, e.key) || ct(t.Vi, e.Vi);
    }, 
    /** Compare by ID then by key */ t.Ii = function(t, e) {
    ...
    function t(t, e) {
        ...
        this.Si = new Un(ys.yi);
    }
    return t.prototype.checkEmpty = function(t) {
        return di.resolve(0 === this.$s.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.vi;
        this.vi++, this.$s.length > 0 && this.$s[this.$s.length - 1];
        var o = new _i(i, e, n, r);
        this.$s.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Si = this.Si.add(new ys(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return di.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return di.resolve(this.Di(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.Ci(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return di.resolve(this.$s.length > i ? this.$s[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return di.resolve(0 === this.$s.length ? -1 : this.vi - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return di.resolve(this.$s.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new ys(e, 0), i = new ys(e, Number.POSITIVE_INFINITY), o = [];
        return this.Si.forEachInRange([ r, i ], (function(t) {
            var e = n.Di(t.Vi);
            o.push(e);
        })), di.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new Un(ct);
        return e.forEach((function(t) {
            var e = new ys(t, 0), i = new ys(t, Number.POSITIVE_INFINITY);
            n.Si.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.Vi);
            }));
        })), di.resolve(this.xi(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new ys(new Pt(i), 0), s = new Un(ct);
        // Find unique batchIDs referenced by all documents potentially matching the
        // query.
                return this.Si.forEachWhile((function(t) {
            var e = t.key.path;
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === r && (s = s.add(t.Vi)), !0);
        }), o), di.resolve(this.xi(s));
        ...
        var n = this;
        z(0 === this.Ni(e.batchId, "removed")), this.$s.shift();
        var r = this.Si;
        return di.forEach(e.mutations, (function(i) {
            var o = new ys(i.key, e.batchId);
        ...
        var n = new ys(e, 0), r = this.Si.firstAfterOrEqual(n);
        return di.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.$s.length, di.resolve();
    }, 
    /**
    ...
    t.prototype.Ci = function(t) {
        return 0 === this.$s.length ? 0 : t - this.$s[0].batchId;
    ...
    t.prototype.Di = function(t) {
        var e = this.Ci(t);
        return e < 0 || e >= this.$s.length ? null : this.$s[e];
    }, t;
}(), ms = /** @class */ function() {
    /**
    ...
    function t(t) {
        ...
        this.docs = new On(Pt.comparator), 
    ...
    t.prototype.addEntry = function(t, e) {
        var n = e.key, r = this.docs.get(n), i = r ? r.size : 0, o = this.ki(e);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return di.resolve(n ? n.document.mutableCopy() : ie.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = jn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : ie.newInvalidDocument(t));
        })), di.resolve(r);
    }, t.prototype.getAllFromCollection = function(t, e, n) {
        for (var r = jn(), i = new Pt(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value.document;
            if (!e.isPrefixOf(u.path)) break;
            u.path.length > e.length + 1 || de(he(a), n) <= 0 || (r = r.insert(a.key, a.mutableCopy()));
        }
        return di.resolve(r);
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        ...
        return di.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        ...
        return di.resolve(this.size);
    }, t;
}(), gs = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).qn = t, n;
    }
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [];
        return this.changes.forEach((function(r, i) {
            i.isValidDocument() ? n.push(e.qn.addEntry(t, i)) : e.qn.removeEntry(r);
        })), di.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
...
}(Mo), ws = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Oi = new Pn((function(t) {
            return ve(t);
        }), me), 
        ...
        /**
             ...
             * IDs.
             */
        this.$i = new ps, this.targetCount = 0, this.Bi = bo.mn();
    }
    return t.prototype.forEachTarget = function(t, e) {
        return this.Oi.forEach((function(t, n) {
            return e(n);
        })), di.resolve();
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return di.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return di.resolve(this.Fi);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Bi.next(), di.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Bi = new bo(e), this.highestTargetId = e), t.sequenceNumber > this.Fi && (this.Fi = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.In(e), this.targetCount += 1, di.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.In(e), di.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.Oi.delete(e.target), this.$i.Ri(e.targetId), this.targetCount -= 1, 
        di.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Oi.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.Oi.delete(s), o.push(r.removeMatchingKeysForTargetId(t, u.targetId)), 
            i++);
        })), di.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return di.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.Oi.get(e) || null;
        return di.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.$i.Ti(e, n), di.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.$i.Ai(e, n);
        ...
        return this.$i.Ri(e), di.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.$i.Pi(e);
        return di.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return di.resolve(this.$i.containsKey(e));
    }, t;
}(), bs = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.Li = {}, this.overlays = {}, this.ts = new st(0), this.es = !1, this.es = !0, 
        this.referenceDelegate = t(this), this.ls = new ws(this), this.indexManager = new no, 
        this.fs = new ms((function(t) {
            return n.referenceDelegate.Ui(t);
        })), this.M = new Ci(e), this.ds = new fs(this.M);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new ds, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.Li[t.toKey()];
        return n || (n = new vs(e, this.referenceDelegate), this.Li[t.toKey()] = n), n;
    }, t.prototype.getTargetCache = function() {
        return this.ls;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.fs;
        ...
        var i = new Is(this.ts.next());
        return this.referenceDelegate.qi(), n(i).next((function(t) {
        ...
        return di.or(Object.values(this.Li).map((function(n) {
            return function() {
    ...
    return t.Wi = function(e) {
        ...
        return this.Qi.addReference(n, e), this.zi.delete(n.toString()), di.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Qi.removeReference(n, e), this.zi.add(n.toString()), di.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.zi.add(e.toString()), di.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.Qi.Ri(e.targetId).forEach((function(t) {
            return n.zi.add(t.toString());
        }));
        ...
        // Remove newly orphaned documents.
                return di.forEach(this.zi, (function(r) {
            var i = Pt.fromPath(r);
            return e.Hi(t, i).next((function(t) {
        ...
        return this.Hi(t, e).next((function(t) {
            t ? n.zi.delete(e.toString()) : n.zi.add(e.toString());
        }));
        ...
        var n = this;
        return di.or([ function() {
            return di.resolve(n.Qi.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Ki(t, e);
        } ]);
    }, t;
}();
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function Ss(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function _s(t, e) {
...
var Ns = /** @class */ function() {
    ...
    return t.Ji = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Xn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Lt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Jn = e, this.persistenceKey = n, this.tr = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.er = this.nr.bind(this), 
        this.sr = new On(ct), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.rr = Ts(this.persistenceKey, this.tr), 
        this.ur = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.sr = this.sr.insert(this.tr, new xs), this.ar = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        this.cr = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.hr = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), 
        this.lr = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.vt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            var t, e, n, i, o, s, u, a, c, l, h, f = this;
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.syncEngine.Os() ];

                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.tr && (o = this.getItem(Ts(this.persistenceKey, i))) && (s = As.Ji(i, o)) && (this.sr = this.sr.insert(s.clientId, s));
                    for (this._r(), (u = this.storage.getItem(this.lr)) && (a = this.wr(u)) && this.mr(a), 
        ...
        // by another tab
            ...
            var n = this.storage.getItem(_s(this.persistenceKey, t));
            if (n) {
                var r = Ds.Ji(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(_s(this.persistenceKey, t));
        ...
        // `Window.addEventListener`.
            ...
            this.Jn.enqueueRetryable((function() {
                return n(e, void 0, void 0, (function() {
                    var t, e, n, o, s, u, a, c = this;
                    return r(this, (function(r) {
                        switch (r.label) {
                          case 0:
                            return this.started ? null === i.key ? [ 3 /*break*/ , 7 ] : this.ar.test(i.key) ? null == i.newValue ? (t = this.Rr(i.key), 
                            [ 2 /*return*/ , this.br(t, null) ]) : (e = this.Pr(i.key, i.newValue)) ? [ 2 /*return*/ , this.br(e.clientId, e) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 1 ] : [ 3 /*break*/ , 8 ];

                          case 1:
                            return this.cr.test(i.key) ? null !== i.newValue && (n = this.Vr(i.key, i.newValue)) ? [ 2 /*return*/ , this.vr(n) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 2 ];

                          case 2:
                            return this.hr.test(i.key) ? null !== i.newValue && (o = this.Sr(i.key, i.newValue)) ? [ 2 /*return*/ , this.Dr(o) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 3 ];

                          case 3:
                            return i.key !== this.lr ? [ 3 /*break*/ , 4 ] : null !== i.newValue && (s = this.wr(i.newValue)) ? [ 2 /*return*/ , this.mr(s) ] : [ 3 /*break*/ , 7 ];

                          case 4:
                            return i.key !== this.ur ? [ 3 /*break*/ , 5 ] : (u = function(t) {
                                var e = st.A;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), u !== st.A && this.sequenceNumberHandler(u), [ 3 /*break*/ , 7 ]);
        ...
        var r = new Ns(this.currentUser, t, e, n), i = Ss(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Yi());
    }, t.prototype.pr = function(t) {
        var e = Ss(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = _s(this.persistenceKey, t), i = new Ds(t, e, n);
        this.setItem(r, i.Yi());
    ...
    t.prototype.Vr = function(t, e) {
        var n = this.cr.exec(t), r = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return Ns.Ji(new L(i), r, e);
    }, 
    /**
    ...
    t.prototype.wr = function(t) {
        ...
        var n = this, r = e ? this.sr.insert(t, e) : this.sr.remove(t), i = this.gr(this.sr), o = this.gr(r), s = [], u = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || u.push(t);
        })), this.syncEngine.Or(s, u).then((function() {
            n.sr = r;
        }));
    ...
    function t() {
        this.Fr = new xs, this.$r = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.Fr = new xs, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t.prototype.Br = function(t) {
        ...
        for (var t = 0, e = this.Kr; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    ...
    return t(n, e), n.prototype.ao = function(t, e, n, r) {
        ...
        var r = [ this.so, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = A(), o = C(), s = {
        ...
        this.useFetchStreams && (s.xmlHttpFactory = new x({})), this.uo(s.initMessageHeaders, e, n), 
        ...
        var a = i.createWebChannel(u, s), c = !1, l = !1, h = new Ps({
            jr: function(t) {
        ...
        return f(a, k.EventType.OPEN, (function() {
            ...
            l || (l = !0, G("Connection", "WebChannel transport errored:", t), h.eo(new Y(H.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
    ...
    return t.prototype.ro = function(t, e, n, r, i) {
        ...
        var s = {};
        return this.uo(s, r, i), this.ao(t, o, s, n).then((function(t) {
 ...
 * limitations under the License.
 */ function Us(t) {
    return new lr(t, /* useProto3Json= */ !0);
}
 ...
 */ var Bs = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Jn = t, this.timerId = e, this.lo = n, this.fo = r, this._o = i, this.wo = 0, 
        this.mo = null, 
    ...
    t.prototype.Io = function(t) {
        ...
        this.mo = this.Jn.enqueueAfterDelay(this.timerId, i, (function() {
    ...
    function t(t, e, n, r, i, o, s, u) {
        this.Jn = t, this.Ao = n, this.Ro = r, this.bo = i, this.authCredentialsProvider = o, 
        ...
        /**
             ...
             * close.
             */
        this.Po = 0, this.Vo = null, this.vo = null, this.stream = null, this.So = new Bs(t, e)
        /**
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.So.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(e.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.So.po()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Jr(e) ];
    ...
    t.prototype.Bo = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.Go(t, e), this.stream.zr((function() {
            r((function() {
                return n.state = 2 /* Open */ , n.vo = n.Jn.enqueueAfterDelay(n.Ro, 1e4, (function() {
    ...
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "listen_stream_connection_backoff" /* ListenStreamConnectionBackoff */ , "listen_stream_idle" /* ListenStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).M = o, 
        u;
    }
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? H.UNKNOWN : Ln(t.code);
                    return new Y(e, t.message || "");
                }(s);
                n = new rr(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = gr(t, a.document.name), l = pr(a.document.updateTime), h = new ne({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = ie.newFoundDocument(c, l, h), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new er(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = gr(t, y.document), m = y.readTime ? pr(y.readTime) : dt.min(), g = ie.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new er([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = gr(t, b.document), E = b.removedTargetIds || [];
                n = new er([], E, I, null);
            } else {
                ...
                var T = e.filter;
                T.targetId;
                var S = T.count || 0, _ = new Vn(S), N = T.targetId;
                n = new nr(N, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? dt.min() : e.readTime ? pr(e.readTime) : dt.min();
        }(t);
    ...
    n.prototype.Qo = function(t) {
        var e = {};
        e.database = Ir(this.M), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = ge(r) ? {
                documents: Dr(t, r)
            } : {
                query: Ar(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = fr(t, e.resumeToken) : e.snapshotVersion.compareTo(dt.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = hr(t, e.snapshotVersion.toTimestamp())), n;
        }(this.M, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    n.prototype.jo = function(t) {
        var e = {};
        e.database = Ir(this.M), e.removeTarget = t, this.Oo(e);
    }, n;
}(Gs), js = /** @class */ function(e) {
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "write_stream_connection_backoff" /* WriteStreamConnectionBackoff */ , "write_stream_idle" /* WriteStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).M = o, 
        u.Wo = !1, u;
    }
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = pr(e)), new yn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
    ...
    n.prototype.Xo = function() {
        ...
        var t = {};
        t.database = Ir(this.M), this.Oo(t);
    }, 
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.co = function(t, e, n) {
        var r = this;
        return this.tu(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
            return r.bo.co(t, e, n, o, s);
        })).catch((function(t) {
            throw "FirebaseError" === t.name ? (t.code === H.UNAUTHENTICATED && (r.authCredentials.invalidateToken(), 
            r.appCheckCredentials.invalidateToken()), t) : new Y(H.UNKNOWN, t.toString());
        }));
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.fu = [], this.du = s, this.du.Br((function(t) {
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return nu(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).lu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Ys(e) ];
 ...
 */ function Hs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (!nu(t)) return [ 3 /*break*/ , 4 ];
                e = 0, n = t.fu, r.label = 1;
 ...
 */ function $s(t, e) {
    var n = W(t), r = gu(n);
    n.hu.delete(e), r.Co() && Zs(n, e), 0 === n.hu.size && (r.Co() ? r.ko() : nu(n) && 
...
function eu(t) {
    return nu(t) && !gu(t).Do() && t.hu.size > 0;
}
...
function su(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t._u.set("Online" /* Online */), !(e instanceof rr && 2 /* Removed */ === e.state && e.cause)) 
                    ...
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], t.hu.has(s) ? [ 4 /*yield*/ , t.remoteSyncer.rejectListen(s, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                r.sent(), t.hu.delete(s), t.wu.removeTarget(s), r.label = 3;
              ...
              case 6:
                if (e instanceof er ? t.wu.ut(e) : e instanceof nr ? t.wu._t(e) : t.wu.ht(e), i.isEqual(dt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , ts(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.hu.set(e, n.withResumeToken(Tt.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Ai(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Xs(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , uu(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.lu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ys(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t._u.set("Offline" /* Offline */), i || (
                // Use a simple read operation to determine if IndexedDB recovered.
                // Ideally, we would expose a health check directly on SimpleDb, but
                // RemoteStore only has access to persistence through LocalStore.
                i = function() {
                    return ts(t.localStore);
                }), 
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.lu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Hs(t) ];
...
function cu(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = wu(e), i = e.cu.length > 0 ? e.cu[e.cu.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , rs(e.localStore, i) ];

              case 3:
                return null === (o = r.sent()) ? (0 === e.cu.length && n.ko(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.cu.push(e);
                    var n = wu(t);
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , uu(e, s) ];
...
function lu(t) {
    return nu(t) && !wu(t).Do() && t.cu.length > 0;
}
...
function du(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = wu(t), n = 0, i = t.cu; n < i.length; n++) o = i[n], e.Ho(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function pu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.cu.shift(), o = Ni.from(n, e, i), [ 4 /*yield*/ , au(t, (function() {
...
function yu(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && wu(t).zo ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return Rn(i = e.code) && i !== H.ABORTED ? (n = t.cu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                wu(t).No(), [ 4 /*yield*/ , au(t, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                n.lu.add(3 /* CredentialChange */), [ 4 /*yield*/ , Ys(n) ];

              case 1:
                return r.sent(), i && 
                // Don't set the network status to Unknown if we are offline.
                n._u.set("Unknown" /* Unknown */), [ 4 /*yield*/ , n.remoteSyncer.handleCredentialChange(e) ];

              case 2:
                return r.sent(), n.lu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Hs(n) ];
 ...
 */ function mu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.lu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Hs(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.lu.add(2 /* IsSecondary */), [ 4 /*yield*/ , Ys(n) ]);

              case 3:
                r.sent(), n._u.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function gu(t) {
    ...
    t.mu = function(t, e, n) {
        var r = W(t);
        return r.tu(), new Ks(e, r.bo, r.authCredentials, r.appCheckCredentials, r.M, n);
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.mu.No(), eu(t) ? tu(t) : t._u.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.mu.stop() ];

                  case 2:
                    e.sent(), ru(t), e.label = 3;
...
function wu(t) {
    ...
    t.gu = function(t, e, n) {
        var r = W(t);
        return r.tu(), new js(e, r.bo, r.authCredentials, r.appCheckCredentials, r.M, n);
    }(t.datastore, t.asyncQueue, {
        zr: fu.bind(null, t),
        Jr: yu.bind(null, t),
        Yo: du.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.gu.No(), [ 4 /*yield*/ , cu(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.cu.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.cu.length + " pending writes"), 
                    t.cu = []), e.label = 4;
 ...
 */ function Iu(t, e) {
    if (B("AsyncQueue", e + ": " + t), gi(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Eu = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = Qn(), this.sortedSet = new On(this.comparator)
        /**
    ...
    this.queries = new Pn((function(t) {
        return Qe(t);
    }), ze), this.onlineState = "Unknown" /* Unknown */ , this.Tu = new Set;
};
 ...
 */ function Du(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new _u), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return u.Iu = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return a = r.sent(), c = Iu(a, "Initialization of query '" + We(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.Eu(n.onlineState), s.Iu && e.Au(s.Iu) && ku(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Mu = /** @class */ function() {
    ...
    t.prototype.fi = function(t) {
        return t.metadata.exists ? Sr(this.M, t.document, !1) : ie.newNoDocument(this.li(t.metadata.name), this.di(t.metadata.readTime));
    }, t.prototype.di = function(t) {
        return pr(t);
    }, t;
}(), Lu = /** @class */ function() {
    function t(t, e, n) {
        ...
        this.collectionGroups = new Set, this.progress = Pu(t)
        /**
    ...
    return t.prototype.Nu = function(t) {
        ...
        for (var e = new Map, n = new Ru(this.M), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var s = n.li(o.metadata.name), u = 0, a = o.metadata.queries; u < a.length; u++) {
                var c = a[u], l = (e.get(c) || Jn()).add(s);
                e.set(c, l);
            }
        }
        return e;
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , ls(this.localStore, new Ru(this.M), this.documents, this.xu.id) ];

                  case 1:
                    t = r.sent(), e = this.ku(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , hs(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Ou = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Jn(), this.Lu = Je(t), this.Uu = new Eu(this.Lu);
    }
    ...
    t.prototype.Gu = function(t, e) {
        var n = this, r = e ? e.Ku : new Tu, i = e ? e.Uu : this.Uu, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = Oe(this.query) && i.size === this.query.limit ? i.last() : null, c = Fe(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var l = i.get(t), h = He(n.query, e) ? e : null, f = !!l && n.mutatedKeys.has(l.key), d = !!h && (h.hasLocalMutations || 
            ...
            u = !0)), p && (h ? (s = s.add(h), o = d ? o.add(t) : o.delete(t)) : (s = s.delete(t), 
            o = o.delete(t)));
        })), Oe(this.query) || Fe(this.query)) for (;s.size > this.query.limit; ) {
            var l = Oe(this.query) ? s.last() : s.first();
            s = s.delete(l.key), o = o.delete(l.key), r.track({
                type: 1 /* Removed */ ,
                doc: l
            });
        }
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        var s = e ? this.Wu() : [], u = 0 === this.Bu.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.$u;
        return this.$u = u, 0 !== o.length || a ? {
            snapshot: new Su(this.query, t.Uu, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            zu: s
        } : {
            zu: s
    ...
    t.prototype.ju = function(t) {
        ...
        // updating many documents.
                var e = this.Bu;
        this.Bu = Jn(), this.Uu.forEach((function(e) {
            t.Hu(e.key) && (t.Bu = t.Bu.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Bu.has(e) || n.push(new Fu(e));
        })), this.Bu.forEach((function(t) {
            e.has(t) || n.push(new Ou(t));
        })), n;
    }, 
    /**
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.Zu = {}, this.ta = new Pn((function(t) {
            return Qe(t);
        }), ze), this.ea = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.sa = new On(Pt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.ia = new Map, this.ra = new ps, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.oa = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ua = new Map, this.aa = bo.gn(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                i = s.targetId, n.sharedClientState.addLocalQueryTarget(i), o = s.view.Yu(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , is(n.localStore, Ke(e)) ];

              case 2:
                return u = r.sent(), n.isPrimaryClient && Js(n.remoteStore, u), a = n.sharedClientState.addLocalQueryTarget(u.targetId), 
                i = u.targetId, [ 4 /*yield*/ , ju(n, e, i, "current" === a) ];
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Gu(i), n.ei ? [ 4 /*yield*/ , ss(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (ra(t, e.targetId, u.zu), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , ss(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = f.sent(), u = new qu(e, s.hi), a = u.Gu(s.documents), c = tr.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                l = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), ra(t, i, l.zu), h = new Uu(e, i, u), 
                [ 2 /*return*/ , (t.ta.set(e, h), t.ea.has(i) ? t.ea.get(i).push(e) : t.ea.set(i, [ e ]), 
                l.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function zu(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.ta.get(e), (o = n.ea.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.ea.set(i.targetId, o.filter((function(t) {
                    return !ze(t, e);
                }))), void n.ta.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , os(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), $s(n.remoteStore, i.targetId), 
                    ea(n, i.targetId);
                })).catch(_o) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return ea(n, i.targetId), [ 4 /*yield*/ , os(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.ai.qs(t, o).next((function(o) {
                            n = o;
                            for (
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], l = In(c, n.get(c.key));
                                null != l && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new _n(c.key, l, re(l.value.mapValue), vn.exists(!0)));
                            }
                            return r.$s.addMutationBatch(t, i, s, e);
                        }));
                    })).then((function(t) {
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.oa[t.currentUser.toKey()];
                    r || (r = new On(ct)), r = r.insert(e, n), t.oa[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , sa(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , cu(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = Iu(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , es(n.localStore, e) ];
 ...
 */ function Hu(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.Zu.Ko(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.ia.get(e), 
                (s = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                u = (u = new On(Pt.comparator)).insert(s, ie.newNoDocument(s, dt.min())), a = Jn().add(s), 
                c = new Zn(dt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Un(ct), u, a), [ 4 /*yield*/ , Wu(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.sa = n.sa.remove(s), n.ia.delete(e), oa(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , os(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return ea(n, e, i);
                })).catch(_o) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Zo(n.localStore, e) ];
              ...
              case 2:
                ...
                ta(n, i, /*error=*/ null), Zu(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , sa(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        var r;
                        return n.$s.lookupMutationBatch(t, e).next((function(e) {
                            return z(null !== e), r = e.keys(), n.$s.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.$s.performConsistencyCheck(t);
                        })).next((function() {
                            return n.ai.qs(t, r);
              ...
              case 2:
                ...
                // listen events.
                ta(n, e, i), Zu(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , sa(n, o) ];
 ...
 */ function Xu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                nu((n = W(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 1:
                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , function(t) {
                    ...
                    return e.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", (function(t) {
                        return e.$s.getHighestUnacknowledgedBatchId(t);
                    }));
                }(n.localStore) ];

              case 2:
                return -1 === (i = r.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((o = n.ua.get(i) || []).push(e), 
                n.ua.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return s = r.sent(), u = Iu(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function ta(t, e, n) {
    var r = W(t), i = r.oa[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.oa[r.currentUser.toKey()] = i;
    }
}

function ea(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.ea.get(e); r < i.length; r++) {
        var o = i[r];
        t.ta.delete(o), n && t.Zu.la(o, n);
    }
    t.ea.delete(e), t.isPrimaryClient && t.ra.Ri(e).forEach((function(e) {
        t.ra.containsKey(e) || 
...
function na(t, e) {
    ...
    var n = t.sa.get(e);
    null !== n && ($s(t.remoteStore, n), t.sa = t.sa.remove(e), t.ia.delete(n), oa(t));
}

function ra(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ou ? (t.ra.addReference(o.key, e), ia(t, o)) : o instanceof Fu ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.ra.removeReference(o.key, e), t.ra.containsKey(o.key) || 
        // We removed the last reference for this key
        na(t, o.key)) : j();
    }
}
...
function ia(t, e) {
    ...
    t.sa.get(n) || t.na.has(r) || (U("SyncEngine", "New document in limbo: " + n), t.na.add(r), 
    oa(t));
}
 ...
 */ function oa(t) {
    for (;t.na.size > 0 && t.sa.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.na.values().next().value;
        t.na.delete(e);
        var n = new Pt(gt.fromString(e)), r = t.aa.next();
        t.ia.set(r, new Bu(n)), t.sa = t.sa.insert(n, r), Js(t.remoteStore, new Ai(Ke(Pe(n.path)), r, 2 /* LimboResolution */ , st.A));
    }
}
...
function sa(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], u = [], a = [], o.ta.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.ta.forEach((function(t, n) {
                    a.push(o.ha(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = Ho.Js(n.targetId, t);
                            u.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.Zu.Ko(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i, o, s, u, a, c, l, h;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                n = W(t), r.label = 1;
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return di.forEach(e, (function(e) {
                                        return di.forEach(e.zs, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return di.forEach(e.Hs, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = n.si.get(a), 
                                l = c.snapshotVersion, h = c.withLastLimboFreeSnapshotVersion(l), 
                                // Advance the last limbo free snapshot version
                                n.si = n.si.insert(a, h));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                [ 4 /*yield*/ , Xo(n.localStore, e) ]);

              case 1:
                return i = r.sent(), n.currentUser = e, 
                // Fails tasks waiting for pending writes requested by previous user.
                function(t, e) {
                    t.ua.forEach((function(t) {
                        t.forEach((function(t) {
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , sa(n, i.ci) ];
...
function aa(t, e) {
    var n = W(t), r = n.ia.get(e);
    if (r && r.Xu) return Jn().add(r.key);
    var i = Jn(), o = n.ea.get(e);
    if (!o) return i;
    for (var s = 0, u = o; s < u.length; s++) {
        var a = u[s], c = n.ta.get(a);
 ...
 */ function ca(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ss((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Ju(i), [ 2 /*return*/ , (n.isPrimaryClient && ra(n, e.targetId, o.zu), 
                o) ];
            }
        }));
    }));
...
function la(t, e) {
    return n(this, void 0, void 0, (function() {
        var n;
        return r(this, (function(r) {
            return [ 2 /*return*/ , as((n = W(t)).localStore, e).then((function(t) {
                return sa(n, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.ln(t, e).next((function(e) {
                            return e ? n.ai.qs(t, e) : di.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , cu(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                ta(n, e, o || null), Zu(n, e), function(t, e) {
                    W(W(t).$s).dn(e);
                }(n.localStore, e)) : j(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , sa(n, s) ];
...
function fa(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return ga(n = W(t)), wa(n), !0 !== e || !0 === n.ca ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , da(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.ca = !0, [ 4 /*yield*/ , mu(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Js(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== e || !1 === n.ca ? [ 3 /*break*/ , 7 ] : (c = [], l = Promise.resolve(), 
                n.ea.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : l = l.then((function() {
                        return ea(n, e), os(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), $s(n.remoteStore, e);
                })), [ 4 /*yield*/ , l ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , da(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    var e = W(t);
                    e.ia.forEach((function(t, n) {
                        $s(e.remoteStore, n);
                    })), e.ra.bi(), e.ia = new Map, e.sa = new On(Pt.comparator);
                }(n), n.ca = !1, [ 4 /*yield*/ , mu(n.remoteStore, !1) ];
...
function da(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u, a, c, l, h, f, d, p, y, v;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
              ...
              case 1:
                return s < u.length ? (a = u[s], c = void 0, (l = n.ea.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , is(n.localStore, Ke(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = n.ta.get(d), [ 4 /*yield*/ , ca(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , us(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , is(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , ju(n, pa(v), a, 
                /*current=*/ !1) ];
...
function ya(t) {
    var e = W(t);
    return W(W(e.localStore).persistence).Os();
}
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                if (!((s = n.ea.get(e)) && s.length > 0)) return [ 3 /*break*/ , 7 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 1 ];
              ...
              case 1:
                return [ 4 /*yield*/ , as(n.localStore, Ye(s[0])) ];

              case 2:
                return u = r.sent(), a = Zn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , sa(n, u, a) ];
              ...
              case 5:
                return r.sent(), ea(n, e, o), [ 3 /*break*/ , 7 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function ma(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, l, h, f, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = ga(t)).ca) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.ea.has(u) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , us(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , is(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , ju(n, pa(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Js(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                l = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.ea.has(t) ? [ 4 /*yield*/ , os(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                $s(n.remoteStore, t), ea(n, t);
                            })).catch(_o) ] : [ 3 /*break*/ , 2 ];
...
function ga(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Wu.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = aa.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Yu.bind(null, e), e.Zu.Ko = Cu.bind(null, e.eventManager), 
    e.Zu.la = xu.bind(null, e.eventManager), e;
}

function wa(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Ju.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = $u.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Pu(n)), o = new Lu(n, t.localStore, e.M), [ 4 /*yield*/ , e.fa() ];

                  case 5:
                    s = r.sent(), r.label = 6;

                  case 6:
                    return s ? [ 4 /*yield*/ , o.Nu(s) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (u = r.sent()) && i._updateProgress(u), [ 4 /*yield*/ , e.fa() ];
                  ...
                  case 11:
                    return a = r.sent(), [ 4 /*yield*/ , sa(t, a.Ou, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (
                    // Save metadata, so loading the same bundle will skip.
                    r.sent(), i._completeWith(a.progress), Promise.resolve(a.Mu)) ];

                  case 14:
                    return [ 2 /*return*/ , (G("SyncEngine", "Loading bundle failed with " + (c = r.sent())), 
...
var Ia = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.M = Us(t.databaseInfo.databaseId), this.sharedClientState = this.da(t), 
                    this.persistence = this._a(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.gcScheduler = this.wa(t), this.localStore = this.ma(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return $o(this.persistence, new Yo, t.initialUser, this.M);
    }, t.prototype._a = function(t) {
        return new bs(Es.Wi, this.M);
    ...
    function i(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ga = t, i.cacheSizeBytes = n, i.forceOwnership = r, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , this.ga.initialize(this, t) ];

                  case 2:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , wa(this.ga.syncEngine) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , cu(this.ga.remoteStore) ];

                  case 4:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return r.sent(), [ 4 /*yield*/ , this.persistence.Is((function() {
        ...
        return new Ao(e, t.asyncQueue);
    }, i.prototype._a = function(t) {
        var e = Qo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ho.withCacheSize(this.cacheSizeBytes) : ho.DEFAULT;
        return new Ko(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Fs(), qs(), this.M, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.da = function(t) {
        return new Ms;
    }, i;
}(Ia), Ta = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
        return (r = e.call(this, t, n, /* forceOwnership= */ !1) || this).ga = t, r.cacheSizeBytes = n, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.ga.syncEngine, this.sharedClientState instanceof ks ? (this.sharedClientState.syncEngine = {
                        kr: ha.bind(null, i),
                        Mr: va.bind(null, i),
                        Or: ma.bind(null, i),
                        Os: ya.bind(null, i),
                  ...
                  case 3:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return [ 4 /*yield*/ , this.persistence.Is((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , fa(this.ga.syncEngine, t) ];
        ...
        var e = Fs();
        if (!ks.vt(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Qo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new ks(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Ea), Sa = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Hu(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = ua.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , mu(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Us(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Os(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n, r) {
            return new zs(t, e, n, r);
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Hu(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Rs.vt() ? new Rs : new Vs, new Ws(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new Gu(t, e, n, r, i, o);
            return s && (u.ca = !0), u;
 ...
 */ var Na = /** @class */ function() {
    ...
    t.prototype.Ea = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Aa() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.Ta.decode(t), 
                    n = Number(e), isNaN(n) && this.Ra("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.ba(n) ]);

                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Vu(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    /** First index of '{' from the underlying buffer. */ t.prototype.Pa = function() {
    ...
    t.prototype.Aa = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Pa() < 0 ? [ 4 /*yield*/ , this.Va() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.Pa()) < 0 && this.Ra("Reached the end of bundle when a length string is expected."), 
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    n.sent() && this.Ra("Reached the end of bundle when more is expected."), n.label = 2;
    ...
    return t.prototype.lookup = function(t) {
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = Ir(n.M) + "/documents", o = {
                                        documents: e.map((function(t) {
                                            return mr(n.M, t);
                                        }))
                                    }, [ 4 /*yield*/ , n.co("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = gr(t, e.found.name), r = pr(e.found.updateTime), i = new ne({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return ie.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                z(!!e.missing), z(!!e.readTime);
                                                var n = gr(t, e.missing), r = pr(e.readTime);
                                                return ie.newNoDocument(n, r);
                                            }(t, e) : j();
                                        }(n.M, t);
        ...
        this.write(new kn(t, this.precondition(t))), this.writtenDocs.add(t.toString());
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = Pt.fromPath(n);
                        e.mutations.push(new Mn(r, e.precondition(r)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? vn.updateTime(e) : vn.none();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        ...
        this.va = 5, this.So = new Bs(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.So.Io((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Aa(this.datastore), (e = this.Da(t)) && e.then((function(e) {
        ...
        var e = this;
        this.va > 0 && this.xa(t) ? (this.va -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.Sa(), Promise.resolve();
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = Iu(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Xo(e.localStore, t) ];
            ...
            switch (r.label) {
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return vu(e.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, n) {
                    return vu(e.remoteStore, n);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Ku.bind(null, e.syncEngine), 
                n.onUnlisten = zu.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Ua(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new J;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Wa(t) {
 ...
 */ var Ja = /** @class */ function() {
    function t(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, ja("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ja({}), 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Ja(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new X;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = Ga.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
 ...
 */ function Xa(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        var s, u;
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, u = L.MOCK_USER; else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            s = E(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
        ...
        t._authCredentials = new Z(new $(s, u));
    }
}
 ...
 */ function nc(t, n) {
    ...
    if (t = I(t), Ka("collection", "path", n), t instanceof $a) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Qa(o), new ec(t, /* converter= */ null, o);
    }
    if (!(t instanceof Za || t instanceof ec)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Qa(s), new ec(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function rc(t, e) {
    if (t = Ha(t, $a), Ka("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new tc(t, 
    /* converter= */ null, 
    /**
...
function ic(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = at.R()), Ka("doc", "path", n), t instanceof $a) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return za(o), new Za(t, 
        /* converter= */ null, new Pt(o));
    }
    if (!(t instanceof Za || t instanceof ec)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return za(s), new Za(t.firestore, t instanceof ec ? t.converter : null, new Pt(s));
}
 ...
 * Firestore database.
 */ function oc(t, e) {
    return t = I(t), e = I(e), (t instanceof Za || t instanceof ec) && (e instanceof Za || e instanceof ec) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function sc(t, e) {
    return t = I(t), e = I(e), t instanceof tc && e instanceof tc && t.firestore === e.firestore && ze(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var uc = /** @class */ function() {
    function t() {
        ...
        this.So = new Bs(this, "async_queue_retry" /* AsyncQueueRetry */), 
        ...
        var e = qs();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Ua);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Ga((function() {
            return e.Ma && e.Ba ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Ka = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.ka.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.ka[0]() ];

                  case 2:
                    return n.sent(), this.ka.shift(), this.So.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!gi(t = n.sent())) throw t;
        ...
        var e = this, n = this.Na.then((function() {
            return e.$a = !0, t().catch((function(t) {
                e.Fa = t, e.$a = !1;
                var n = 
                /**
 ...
 */
        ...
        var i = bu.createAndSchedule(this, t, e, n, (function(t) {
            return r.Qa(t);
        }));
    ...
    t.prototype.ja = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.Na ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.Na) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
     ...
     */
    t.prototype.Wa = function(t) {
        for (var e = 0, n = this.Oa; e < n.length; e++) {
    ...
    t.prototype.za = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.Oa.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.Oa; n < r.length; n++) {
                var i = r[n];
...
var cc = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new uc, 
    ...
    return t(n, e), n.prototype._terminate = function() {
        ...
        yc(this), this._firestoreClient.terminate();
    }, n;
}($a);
 ...
 * @internal
 */ function pc(t) {
    return t._firestoreClient || yc(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}
 ...
 */ function vc(t, e) {
    Nc(t = Ha(t, hc));
    var n = pc(t), r = t._freezeSettings(), i = new Sa;
    return gc(n, i, new Ea(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function mc(t) {
    Nc(t = Ha(t, hc));
    var e = pc(t), n = t._freezeSettings(), r = new Sa;
    return gc(e, r, new Ta(r, n.cacheSizeBytes));
}
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return yi.vt() ? (e = t + "main", [ 4 /*yield*/ , yi.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Qo(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Ic(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Oa(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.lu.delete(0 /* UserDisabled */), Hs(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (pc(t = Ha(t, hc)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).lu.add(0 /* UserDisabled */), [ 4 /*yield*/ , Ys(e) ];
...
function _c(t, e) {
    ...
    }(pc(t = Ha(t, hc)), e).then((function(e) {
...
function(t) {
...
}(), Mc = /^__.*__$/, Vc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new _n(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Sn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Rc = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.toMutation = function(t, e) {
        return new _n(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var Pc = /** @class */ function() {
    /**
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Ja(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Xa = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Xa({
            path: n,
            tc: !1
        });
        return r.ec(t), r;
        ...
        return nl(t, this.settings.methodName, this.settings.rc || !1, this.path, this.settings.oc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.ec(this.path.get(t));
    }, t.prototype.ec = function(t) {
        if (0 === t.length) throw this.ic("Document fields must not be empty");
        if (Lc(this.Ya) && Mc.test(t)) throw this.ic('Document fields cannot begin and end with "__"');
    }, t;
}(), Oc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || Us(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.uc = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Pc({
            Ya: t,
            methodName: e,
            oc: n,
            path: bt.emptyPath(),
 ...
 * classes.
 */ function Fc(t) {
    var e = t._freezeSettings(), n = Us(t._databaseId);
    return new Oc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function qc(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.uc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Xc("Data must be an object, but it was:", s, r);
    var u, a, c = Jc(r, s);
    if (o.merge) u = new It(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        ...
        u = new It(l), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new Vc(new ne(c), u, a);
}
...
var Gc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new pn(t.path, new sn);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(xc), Kc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).ac = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = Bc(this, t, 
        /*array=*/ !0), n = this.ac.map((function(t) {
            return Yc(t, e);
        })), r = new un(n);
...
}(xc), zc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).cc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new hn(t.M, tn(t.M, this.cc));
...
/** Parse update data from an update() call. */ function Qc(t, e, n, r) {
    var i = t.uc(1 /* Update */ , e, n);
    Xc("Data must be an object, but it was:", i, r);
    var o = [], s = ne.empty();
    yt(r, (function(t, r) {
        var u = el(e, t, n);
    ...
    var u = new It(o);
    return new Rc(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Wc(t, e, n, r, i, o) {
    var s = t.uc(1 /* Update */ , e, n), u = [ Zc(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Zc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], h = ne.empty(), f = u.length - 1; f >= 0; --f) if (!rl(l, u[f])) {
        var d = u[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new It(l);
    return new Rc(h, m, s.fieldTransforms);
}
 ...
 */ function Hc(t, e, n, r) {
    return void 0 === r && (r = !1), Yc(n, t.uc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Yc(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return Xc("Unsupported field value:", e, t), Jc(t, e);
    if (t instanceof xc) 
    ...
    return function(t, e) {
        ...
        if (!Lc(e.Ya)) throw e.ic(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return tn(e.M, t);
        ...
        if (t instanceof Cc) return {
            bytesValue: fr(e.M, t._byteString)
        };
        if (t instanceof Za) {
            ...
            return {
                referenceValue: yr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.ic("Unsupported field value: " + Wa(t));
    }(t, e);
}
...
function $c(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ft || t instanceof kc || t instanceof Cc || t instanceof Za || t instanceof xc);
}
 ...
 */ function Zc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Dc) return e._internalPath;
    if ("string" == typeof e) return el(t, e);
    throw nl("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function el(t, n, r) {
    if (n.search(tl) >= 0) throw nl("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Dc.bind.apply(Dc, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw nl("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
 ...
 */ var il = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new ol(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(sl("DocumentSnapshot.get", t));
 ...
 */
function sl(t, e) {
    return "string" == typeof e ? el(t, e) : e instanceof Dc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var ul = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new cl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(sl("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(il), cl = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(al), ll = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new ul(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new cl(n._firestore, n._userDataWriter, r.key, r, new ul(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new cl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ul(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new cl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ul(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function dl(t) {
    if (Fe(t) && 0 === t.explicitOrderBy.length) throw new Y(H.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var vl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).hc = t, i.lc = n, i.fc = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Fc(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === o || "not-in" /* NOT_IN */ === o) {
                    kl(s, o);
                    for (var a = [], c = 0, l = s; c < l.length; c++) {
                        var h = l[c];
                        a.push(xl(r, t, h));
                    }
                    u = {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || kl(s, o), 
            u = Hc(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = be.create(i, o, u);
            return function(t, e) {
                if (e.S()) {
                    var n = Ue(t);
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.hc, this.lc, this.fc);
...
var gl = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).hc = t, r.dc = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var bl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i._c = n, i.wc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new tc(t.firestore, t.converter, je(t._query, this._c, this.wc));
    }, n;
}(pl);
 ...
 * @returns The created {@link Query}.
 */ function Il(t) {
    return Ya("limit", t), new bl("limit", t, "F" /* First */)
    /**
...
function El(t) {
    return Ya("limitToLast", t), new bl("limitToLast", t, "L" /* Last */);
}

var Tl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.mc = n, i.gc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Cl(t, this.type, this.mc, this.gc);
        return new tc(t.firestore, t.converter, function(t, e) {
...
function Sl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Tl("startAt", t, 
    /*inclusive=*/ !0);
}

function _l() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Tl("startAfter", t, 
    /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Cl(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof il) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, u = Ge(t); s < u.length; s++) {
            var a = u[s];
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!Be(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function xl(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!Be(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof Za) return Qt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + Wa(n) + ".");
}
 ...
 */ var Vl = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new kc(Nt(t.latitude), Nt(t.longitude));
...
var Ll = /** @class */ function(e) {
...
}(Vl), Pl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Fc(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Ol(t, this._firestore), i = Rl(r.converter, e, n), o = qc(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, vn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Ol(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Dc ? Wc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Qc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, vn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Ol(t, this._firestore);
        return this._mutations = this._mutations.concat(new kn(e._key, vn.none())), this;
    }, 
    /**
 ...
 */ function Fl(t) {
    t = Ha(t, Za);
    var e = Ha(t.firestore, hc);
    return Ua(pc(e), t._key).then((function(n) {
        return Xl(e, t, n);
    }));
}
 ...
 */ function Ul(t) {
    t = Ha(t, Za);
    var e = Ha(t.firestore, hc), i = pc(e), o = new ql(e);
    return function(t, e) {
        var i = this, o = new J;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 2:
                                        return o = r.sent(), s = Iu(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new al(e, o, t._key, n, new ul(null !== n && n.hasLocalMutations, 
 ...
 */ function Gl(t) {
    t = Ha(t, tc);
    var e = Ha(t.firestore, hc), n = pc(e), r = new ql(e);
    return dl(t._query), Ba(n, t._query).then((function(n) {
        return new ll(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , ss(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new qu(e, n.hi), s = o.Gu(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = Iu(a, "Failed to execute query '" + e + " against cache"), 
...
function zl(t, e, n) {
    t = Ha(t, Za);
    var r = Ha(t.firestore, hc), i = Rl(t.converter, e, n);
    return $l(r, [ qc(Fc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, vn.none()) ]);
}

function Ql(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ha(t, Za);
    var o = Ha(t.firestore, hc), s = Fc(o);
    return $l(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Dc ? Wc(s, "updateDoc", t._key, e, n, r) : Qc(s, "updateDoc", t._key, e)).toMutation(t._key, vn.exists(!0)) ]);
}
 ...
 */ function Wl(t) {
    return $l(Ha(t.firestore, hc), [ new kn(t._key, vn.none()) ]);
}
 ...
 */ function Hl(t, e) {
    var n = Ha(t.firestore, hc), r = ic(t), i = Rl(t.converter, e);
    return $l(n, [ qc(Fc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, vn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function Yl(t) {
    ...
    "object" != typeof s[c] || ac(s[c]) || (a = s[c], c++);
    var l, h, f, d = {
    ...
    if (t instanceof Za) h = Ha(t.firestore, hc), f = Pe(t._key.path), l = {
        next: function(e) {
            s[c] && s[c](Xl(h, t, e));
        },
        error: s[c + 1],
        ...
        var y = Ha(t, tc);
        h = Ha(y.firestore, hc), f = y._query;
        var v = new ql(h);
        l = {
            next: function(t) {
                s[c] && s[c](new ll(h, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, dl(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Na(o), a = new Mu(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            u.pa(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Au, [ 4 /*yield*/ , qa(t) ];
...
function Jl(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.pa(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
 ...
 */ function Xl(t, e, n) {
    var r = n.docs.get(e._key), i = new ql(t);
    return new al(t, i, e._key, r, new ul(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var Zl, th = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Ol(t, this._firestore), i = new ql(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new al(n._firestore, i, r._key, t._document, new ul(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Fc(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Ol(t, this._firestore), r = new Ll(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return j();
            var i = t[0];
            if (i.isFoundDocument()) return new il(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new il(e._firestore, r, n._key, null, n.converter);
            throw j();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Ol(t, this._firestore), i = Rl(r.converter, e, n), o = qc(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Dc ? Wc(this._dataReader, "Transaction.update", s._key, e, n, r) : Qc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Ca(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(pc(t = Ha(t, hc)), (function(n) {
        return e(new th(t, n));
    }));
}
 ...
 * writes.
 */ function uh(t) {
    return pc(t = Ha(t, hc)), new Pl(t, (function(e) {
        return $l(t, e);
    }))
    /**
 * @license
...
function ah(t, e) {
    ...
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
        ...
        var s = o[i], u = ch(s, "collectionGroup"), a = [];
        if (Array.isArray(s.fields)) for (var c = 0, l = s.fields; c < l.length; c++) {
            var h = l[c], f = el("setIndexConfiguration", ch(h, "fieldPath"));
            "CONTAINS" === h.arrayConfig ? a.push(new ae(f, 2 /* CONTAINS */)) : "ASCENDING" === h.order ? a.push(new ae(f, 0 /* ASCENDING */)) : "DESCENDING" === h.order && a.push(new ae(f, 1 /* DESCENDING */));
        }
        r.push(new oe(oe.UNKNOWN_ID, u, a, ce.empty()));
    }
 ...
 */ void 0 === Zl && (Zl = !0), P = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new hc(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
